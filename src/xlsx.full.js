...
function make_xlsx_lib(e) {
    ...
    if (r.indexOf("e") > -1) {
      ...
      t =
        t.indexOf(".") > -1
          ...
          : t.slice(0, 15) + Ar("0", t.length - 15);
      return t + r.slice(r.indexOf("e"));
    }
    var a =
      r.indexOf(".") > -1
        ? r.slice(0, r.slice(0, 2) == "0." ? 17 : 16)
        : r.slice(0, 15) + Ar("0", r.length - 15);
    return Number(a);
  }
  function ae(e, r, t) {
  ...
  function be(e, r, t) {
    ...
    return (
      ...
      (s === 0
        ...
        : z(s, e[1].length) + e[2] + "/" + e[3] + W(f, e[4].length))
    );
  }
  function we(e, r, t) {
  ...
  function xe(e, r, t) {
    ...
    if (r.charCodeAt(0) === 36)
      return "$" + xe(e, r.substr(r.charAt(1) == " " ? 2 : 1), t);
    var n;
    var i,
      s,
      f,
    ...
    if ((i = r.match(/^#,##0\.([#0]*0)$/))) {
      return t < 0
        ? "-" + xe(e, r, -t)
        : ue("" + (Math.floor(t) + _e(t, i[1].length))) +
            "." +
            W(Ce(t, i[1].length), i[1].length);
    }
    ...
    if ((i = r.match(/^([0#]+)(\\?-([0#]+))+$/))) {
      ...
      s = 0;
      return B(
        B(r.replace(/\\/g, "")).replace(/[0#]/g, function (e) {
    ...
    if ((i = r.match(/^# ([#0?]+)( ?)\/( ?)([#0?]+)/))) {
      ...
      return (
        ...
        " " +
        (f[1]
          ? z(f[1], s) + i[2] + "/" + i[3] + H(f[2], s)
          : Ar(" ", 2 * s + 1 + i[2].length + i[3].length))
      );
    }
    if ((i = r.match(/^[#0?]+$/))) {
      n = j(t, 0);
  ...
  var Qe = (function dT() {
      ...
      for (; h < c.length; h += 128) {
        ...
        if (g.type === 5) {
          ...
          if (r[g.start] === undefined)
            r[g.start] = m(t, g.start, r.fat_addrs, r.ssz);
    ...
    function F(e, r) {
      ...
      for (s = 0; s < t.length; ++s) {
        if ((f ? t[s].replace(U, "!") : t[s]).replace(M, "") == i)
          return e.FileIndex[s];
        if ((f ? a[s].replace(U, "!") : a[s]).replace(M, "") == i)
          return e.FileIndex[s];
      }
      return null;
    }
    ...
    function We(e, r) {
      if (X(e.slice(0, 13)).toLowerCase() != "mime-version:")
  ...
  function ar(e, r, t) {
    ...
    if (typeof Blob !== "undefined") {
      ...
      if (
        ...
        var f =
          "data:application/octet-stream;base64," + y(new Uint8Array(tr(a)));
        return chrome.downloads.download({
          url: f,
          filename: e,
          saveAs: true,
  ...
  function kr(e, r) {
    if (C && Buffer.isBuffer(e)) {
      if (r && S) {
        ...
        if (e[1] == 254 && e[2] == 255)
          return Tt(d(e.slice(2).toString("binary")));
      }
  ...
  function Pr(e) {
    ...
    if (e._data && e._data.getContent)
      return v(kr(Array.prototype.slice.call(e._data.getContent(), 0)));
    return null;
  }
  function Lr(e) {
    if (!e) return null;
  ...
  function It(e, r, t) {
    return (
      ...
      (t != null ? Rt(t) : "") +
      (r != null
        ? (r.match(xt) ? ' xml:space="preserve"' : "") + ">" + r + "</" + e
        : "/") +
      ">"
    );
  }
    ...
    if (i === "dbcs") {
      ...
      if (typeof a !== "undefined" && t == 874) {
        ...
        if (l.length == n.length)
          for (f = 0; f < n.length; ++f)
            if (l[f] == 0 && n.charCodeAt(f) != 0) l[f] = 95;
        if (l.length == 2 * n.length)
          for (f = 0; f < n.length; ++f)
            if (l[2 * f] == 0 && l[2 * f + 1] == 0 && n.charCodeAt(f) != 0)
              l[2 * f] = 95;
        ...
        for (f = 0; f != n.length; ++f)
          this[this.l + f] = n.charCodeAt(f) & 255;
        s = n.length;
      }
    } else if (i === "hex") {
      for (; f < e; ++f) {
  ...
  function Tn(e) {
    ...
    var n =
      a === 0
        ? sa([0, 0, 0, 0, r[0] & 252, r[1], r[2], r[3]], 0)
        : da(r, 0) >> 2;
    return t ? n / 100 : n;
  }
    ...
    (e.match(qr) || []).forEach(function (e) {
      ...
      switch (a[0].replace(Qr, "<")) {
        ...
        case "<Default":
          ...
          break;
        case "<Override":
          if (r[ii[a.ContentType]] !== undefined)
            r[ii[a.ContentType]].push(a.PartName);
          break;
      }
    });
  ...
  function Ri(e, r, t) {
    ...
    if (a.HeadingPairs && a.TitlesOfParts)
      Oi(a.HeadingPairs, a.TitlesOfParts, r, t);
    return r;
  }
  ...
  function ts(e, r) {
    ...
    for (s = 0; s != n; ++s) {
      ...
      if (r) {
        if (i[s][0] == 0 && i.length > s + 1 && i[s][1] == i[s + 1][1])
          continue;
        var p = r[i[s][0]];
        d[p.n] = es(e, p.t, {
          raw: true,
  ...
  function el(e, r, t) {
    ...
    if (!(t.biff > 8) && r == e[e.l] + (e[e.l + 1] == 3 ? 1 : 0) + 1)
      return rl(e, r, t);
    var a = [],
      n = e.l + r,
      i = e._R(t.biff > 8 ? 4 : 2);
    ...
    function c(i, s) {
      ...
      for (m = 0; m < d.length; ++m) {
        ...
        if (typeof d[m] !== "string")
          throw new Error(
            "DBF Invalid column name " + d[m] + " |" + typeof d[m] + "|"
          );
        if (d.indexOf(d[m]) !== m)
          for (g = 0; g < 1024; ++g)
      ...
      for (m = 0; m <= k.e.c - k.s.c; ++m) {
        ...
        for (g = 0; g < S.length; ++g) {
          ...
          _ = Math.max(
            _,
            (typeof a !== "undefined" && typeof S[g] == "string"
              ? a.utils.encode(t, S[g])
              : String(S[g])
            ).length
          );
          E = E && E != C ? "C" : C;
          ...
          switch (E) {
            ...
            case "NN":
              {
                ...
                for (h = 1; h < y.length; ++h)
                  switch (y[h].charAt(0)) {
                    ...
                    case "E":
                      S.Ref =
                        ((t && t.sheet) || "Sheet1") + "!" + ru(y[h].slice(1));
                      break;
                  }
            ...
            case "C":
              ...
              if (x) {
                ...
                if (v) u[f][o].z = v;
                if (t.cellText !== false && v)
                  u[f][o].w = ze(u[f][o].z, u[f][o].v, {
  ...
  var Yl = (function () {
    ...
    function l(e, r) {
      ...
      if (t.slice(0, 19) == "socialcalc:version:")
        return Kl.to_sheet(r.type == "string" ? t : kt(t), r);
      return f(t, r);
    }
    function o(e, r) {
      return Ya(l(e, r), r);
                ...
                while (x-- > 0 && l >= 0) {
                  if (_ & 32)
                    switch (_ & 31) {
                      ...
                      default:
                        throw (
                          "Cannot apply delta for QPW cell type " + (_ & 31)
                        );
                    }
                  else
                    switch (_ & 31) {
                      ...
                      default:
                        throw (
                          "Cannot apply repeat for QPW cell type " + (_ & 31)
                        );
                    }
                  if (S != -1);
                  if (!(!t.sheetStubs && C.t == "z")) {
  ...
  function no(e, r) {
    ...
    if (e.match(/^\s*<(?:\w+:)?t[^>]*>/)) {
      ...
      a.r = kt(e);
      a.t = it(
        kt((e.replace(ao, "").match(ro) || []).join("").replace(qr, "")),
        true
      );
      if (t) a.h = eo(Ql(a.r));
    }
  ...
  function ec(e) {
    return Math.floor(((e - 5) / qo) * 100 + 0.5) / 100;
  }
  function rc(e) {
    ...
    (e[0].match(qr) || []).forEach(function (e) {
      ...
      switch (tt(i[0])) {
        ...
        case "<xf>":
          a = i;
          delete a[0];
          for (s = 0; s < pc.length; ++s)
            if (a[pc[s]]) a[pc[s]] = parseInt(a[pc[s]], 10);
  ...
  function $h(e, r) {
    ...
    Ea(e, function s(e, f, l) {
      switch (l) {
        ...
        default:
          if (f.T) {
          } else if (!i || r.WTF) throw new Error("Unexpected record 0x" + l.toString(16));
      }
    });
    return t;
  }
  ...
  var nu = (function () {
    return function e(r, t) {
      return r.replace(tu, function (e, r, a, n, i, s) {
        var f = Pa(n) - (a ? 0 : t.c);
        var l = Ia(s) - (i ? 0 : t.r);
        var o = i == "$" ? l + 1 : l == 0 ? "" : "[" + l + "]";
        var c = a == "$" ? f + 1 : f == 0 ? "" : "[" + f + "]";
  ...
  function iu(e, r) {
    return e.replace(tu, function (e, t, a, n, i, s) {
      return (
        t +
        (a == "$" ? a + n : La(Pa(n) + r.c)) +
        (i == "$" ? i + s : Na(Ia(s) + r.r))
  ...
  function Yu(e, r, t) {
    ...
    for (var i = 0, s = []; i != a && (s[i] = []); ++i)
      for (var f = 0; f != n; ++f) s[i][f] = ju(e, t.biff);
    return s;
  }
  function Zu(e, r, t) {
    var a = (e._R(1) >>> 5) & 3;
  ...
  function Dd(e, r) {
    ...
    if (
      t > 0 &&
      a > 0 &&
      e.slice(0, t).toLowerCase() == r.slice(0, a).toLowerCase()
    )
      return e + ":" + r.slice(a + 1);
  ...
  function Lv(e, r, t, a, n, i, s) {
    ...
    if (T)
      for (d = 0; d != T.length; ++d)
        k[d] = Ga(T[d].slice(T[d].indexOf('"') + 1));
    var A = c.match(xv);
    if (A) Xv(f, A, a);
    var y = c.match(Nv);
  ...
  function qv(e, r) {
    if (!r.Views) r.Views = [{}];
    (e.match(Jv) || []).forEach(function (e, t) {
      var a = rt(e);
    ...
    return function f(l, o, c, h, u, d, v) {
      ...
      for (var z = l.split(r), H = 0, V = z.length; H != V; ++H) {
        ...
        for (p = 0; p != g.length; ++p) {
          ...
          for (k = 0; k != m.length; ++k) if (m.charCodeAt(k) === 62) break;
          ++k;
          ...
          if (c.cellFormula) {
            ...
            for (k = 0; k < F.length; ++k)
              if (K.r >= F[k][0].s.r && K.r <= F[k][0].e.r)
                if (K.c >= F[k][0].s.c && K.c <= F[k][0].e.c) y.F = F[k][1];
          }
        ...
        switch (b) {
          ...
          case 62:
            ...
            if ((m = s.CellXf[e[0].iStyleRef]))
              yv(p, m.numFmtId, null, f, i, s, L > 0);
            w = e[0].c == -1 ? w + 1 : e[0].c;
            if (f.dense) {
          ...
          default:
            if (r.T) {
              ...
              throw new Error("Unexpected record 0x" + b.toString(16));
        }
      },
      f
    );
    ...
    if (o.cellFormula !== false) {
      if (a.Formula) {
        ...
        for (p = 0; p < l.length; ++p)
          if (n.r >= l[p][0].s.r && n.r <= l[p][0].e.r)
            if (n.c >= l[p][0].s.c && n.c <= l[p][0].e.c) a.F = l[p][1];
      }
    }
    if (o.cellStyles) {
    ...
    while ((l = Pt.exec(n)))
      switch ((l[3] = (G = l[3]).toLowerCase())) {
        ...
        default:
            ...
            case "worksheetoptions":
              switch (l[3]) {
                case "visible":
                  ...
                  break;
                case "header":
                  if (!p["!margins"]) Tv((p["!margins"] = {}), "xlml");
                  if (!isNaN(+rt(l[0]).Margin))
                    p["!margins"].header = +rt(l[0]).Margin;
                  break;
                case "footer":
                  if (!p["!margins"]) Tv((p["!margins"] = {}), "xlml");
                  if (!isNaN(+rt(l[0]).Margin))
                    p["!margins"].footer = +rt(l[0]).Margin;
                  break;
                case "pagemargins":
                  var ae = rt(l[0]);
                  if (!p["!margins"]) Tv((p["!margins"] = {}), "xlml");
          ...
          if (!o[o.length - 1][1])
            throw "Unrecognized tag: " + l[3] + "|" + o.join("|");
          ...
          case 2:
            {
              if (n["!type"] == "chart")
                if (
                  r.dense ? (n["!data"][J.r] || [])[J.c] : n[La(J.c) + Na(J.r)]
                )
                  ++J.c;
              T = {
                ixfe: J.ixfe,
              ...
              if (z > 0)
                T.z =
                  (T.XF && T.XF.numFmtId && H[T.XF.numFmtId]) ||
                  H[(T.ixfe >> 8) & 63];
  ...
  function Zg(e, r) {
    ...
    if (a.length)
      Qe.utils.cfb_add(r, "/SummaryInformation", fs(a, Kg.SI, l, Zn));
    if (t.length || o.length)
      Qe.utils.cfb_add(
        r,
        "/DocumentSummaryInformation",
        fs(t, Kg.DSI, f, Yn, o.length ? o : null, Kg.UDI)
      );
  }
  function Jg(e, r) {
    if (!r) r = {};
    ...
    if (r.bookProps && !r.bookSheets) n = {};
      ...
      if (a && a.content) n = jg(a.content, r);
        ...
        n = Jl.to_workbook(i.content, ((r.type = f), r));
  ...
  function ib(e, r) {
    r.forEach(function (r) {
      ...
      for (var a = 2048; a < t.length; a += 2048)
        rb(
          e,
          28,
          ll(
            t.slice(a, Math.min(a + 2048, t.length)),
            -1,
            -1,
            Math.min(2048, t.length - a)
          )
        );
    });
  }
  ...
  function vb(e, r, t) {
    ...
    [
      ...
      for (var n = a[0]; n <= a[1]; ++n)
        if (r[n] != null) rb(e, 1054, _f(n, r[n], t));
    });
  }
  function pb(e, r) {
    var t = ya(19);
        ...
        case "str":
          if (n.bookSST) {
            ...
            rb(
              e,
              516,
              Ef(t, a, (r.v == null ? "" : String(r.v)).slice(0, 255), s, n)
            );
          break;
        default:
          rb(e, 513, Ls(t, a, s));
  ...
  function Eb(e, r) {
    ...
    for (f = 0; f < o.length; ++f) {
      ...
      for (l = 0; l < w.length; ++l) {
        ...
        var T = k,
          A = 0;
        while (T.charAt(0) == "<" && (A = T.indexOf(">")) > -1)
          T = T.slice(A + 1);
  ...
  function Cb(e, r, t, a) {
    ...
    for (var l = r.s.c; l <= r.e.c; ++l) {
      ...
      var v =
        (d && d.v != null && (d.h || ht(d.w || (Ka(d), d.w) || ""))) || "";
      s = {};
      if (o > 1) s.rowspan = o;
      if (c > 1) s.colspan = c;
    ...
    for (; p < a.length && m < o; ++p) {
      ...
      for (g = b = 0; g < A.length; ++g) {
        ...
        if (E != null) {
          ...
          else if (n.raw || E.trim().length == 0 || x == "s") {
          } else if (E === "TRUE")
            S = {
              t: "b",
              v: true,
        ...
        if (
          O &&
          O.charAt(0) != "#" &&
          O.slice(0, 11).toLowerCase() != "javascript:"
        )
          S.l = {
            Target: O,
          };
    ...
    while ((i = Pt.exec(n))) {
      switch ((i[3] = i[3].replace(/_.*$/, ""))) {
        ...
        case "scientific-number":
          ...
          f +=
            "0." +
            Ar("0", +o["min-decimal-places"] || +o["decimal-places"] || 2) +
            Ar("?", +o["decimal-places"] - +o["min-decimal-places"] || 0) +
            "E" +
            (pt(o["forced-exponent-sign"]) ? "+" : "") +
            Ar("0", +o["min-exponent-digits"] || 2);
          break;
        case "fraction":
          o = rt(i[0], false);
        ...
        case "currency-symbol":
          if (i[1] === "/") {
            f +=
              '"' +
              n.slice(h, Pt.lastIndex - i[0].length).replace(/"/g, '""') +
              '"';
          } else if (i[0].charAt(i[0].length - 2) !== "/") {
            h = Pt.lastIndex;
          } else f += "$";
        ...
        case "map":
          o = rt(i[0], false);
          if (it(o["condition"]) == "value()>=0")
            f = a[o["apply-style-name"]] + ";" + f;
          else
            console.error(
              "ODS number format may be incorrect: " + o["condition"]
            );
          break;
        case "number":
          if (i[1] === "/") break;
          ...
          if (+o["min-decimal-places"])
            l += Ar("0", +o["min-decimal-places"] || 1);
          if (+o["decimal-places"] - (+o["min-decimal-places"] || 0))
            l += Ar(
              "0",
    ...
    while ((m = Pt.exec(n)))
      switch ((m[3] = m[3].replace(/_.*$/, ""))) {
        ...
        case "数据":
          if (m[0].charAt(m[0].length - 2) === "/") {
            ...
            if (a.cellFormula) {
              ...
              if (w.formula) g.f = uv(w.formula);
                ...
                for (Z = 0; Z < W.length; ++Z)
                  if (S >= W[Z][0].s.r && S <= W[Z][0].e.r)
                    if (x >= W[Z][0].s.c && x <= W[Z][0].e.c) g.F = W[Z][1];
            }
            ...
            if (w["number-columns-repeated"])
              B = parseInt(w["number-columns-repeated"], 10);
            switch (g.t) {
              case "boolean":
                g.t = "b";
        ...
        case "style":
          {
            var re = rt(m[0], false);
            if (re["family"] == "table-cell" && I[re["data-style-name"]])
              N[re["name"]] = I[re["data-style-name"]];
          }
          break;
        case "map":
          break;
  ...
  function hw(e, r) {
    ...
    if (d != a)
      throw new Error("Unexpected length: ".concat(d, " != ").concat(a));
    return n;
  }
  function uw(e) {
    if (Array.isArray(e)) e = new Uint8Array(e);
              ...
              v.forEach(function (r) {
                ...
                if ((t = i[2]) == null ? void 0 : t[0]) {
                  ...
                  switch (f) {
                    ...
                    default:
                      console.log(
                        "unrecognized ObjectAttribute type ".concat(f)
                      );
                  }
                }
              });
  ...
  function _w(e, r) {
    ...
    if (
      ...
      ((h = (c = m[4]) == null ? void 0 : c[0]) == null ? void 0 : h.data) &&
      r != 1
    ) {
    ...
    if (E.length != b)
      throw "Expected ".concat(b, " cells, found ").concat(E.length);
    var S = [];
    for (C = 0; C < E.length - 1; ++C)
      S[E[C][0]] = T[Gb](E[C][1] * A, E[C + 1][1] * A);
  ...
  function xw(e, r) {
    ...
    var d = sw(r);
    if (
      (a = (t = d == null ? void 0 : d[1]) == null ? void 0 : t[0]) == null
        ? void 0
        : a.data
    )
      u.t =
        Kb(
          (i = (n = d == null ? void 0 : d[1]) == null ? void 0 : n[0]) == null
            ? void 0
            : i.data
        ) || "";
    if (
      (f = (s = d == null ? void 0 : d[3]) == null ? void 0 : s[0]) == null
        ? void 0
        : f.data
    ) {
      var v =
        e[
          Tw(
            (o = (l = d == null ? void 0 : d[3]) == null ? void 0 : l[0]) ==
              null
              ? void 0
              : o.data
          )
      ...
      var p = sw(v.data);
      if ((h = (c = p[1]) == null ? void 0 : c[0]) == null ? void 0 : h.data)
        u.a = Kb(p[1][0].data);
    }
  ...
  function Iw(e, r, t, a) {
    ...
    var b = sw(v[4][0].data);
    var w = vw();
    if ((n = b[4]) == null ? void 0 : n[0])
      w.sst = Cw(e, e[Tw(b[4][0].data)][0]);
    if ((i = b[6]) == null ? void 0 : i[0])
      w.fmla = Cw(e, e[Tw(b[6][0].data)][0]);
    if ((s = b[11]) == null ? void 0 : s[0])
      w.ofmt = Cw(e, e[Tw(b[11][0].data)][0]);
    if ((f = b[12]) == null ? void 0 : f[0])
      w.ferr = Cw(e, e[Tw(b[12][0].data)][0]);
    if ((l = b[17]) == null ? void 0 : l[0])
      w.rsst = Cw(e, e[Tw(b[17][0].data)][0]);
    if ((o = b[19]) == null ? void 0 : o[0])
      w.cmnt = Cw(e, e[Tw(b[19][0].data)][0]);
    if ((c = b[22]) == null ? void 0 : c[0])
      w.nfmt = Cw(e, e[Tw(b[22][0].data)][0]);
    var k = sw(b[3][0].data);
    var T = 0;
    if (!((h = b[9]) == null ? void 0 : h[0]))
  ...
  function Pw(e, r) {
    ...
    if (
      ((n =
        (a = (t = o == null ? void 0 : o[1]) == null ? void 0 : t[0].meta) ==
        null
          ? void 0
          : a[1]) == null
        ? void 0
        : n[0].data) &&
      nw(o[1][0].meta[1][0].data) == 1e4
    )
      throw new Error("Pages documents are not supported");
    var h =
      ((l =
        (f =
          (s = (i = o == null ? void 0 : o[1]) == null ? void 0 : i[0]) == null
            ? void 0
            : s.meta) == null
          ? void 0
          : f[1]) == null
  ...
  function fk(e, r) {
    ...
    if (!Ur(e, "[Content_Types].xml")) {
      ...
      if (a) {
        ...
        if (typeof Bun !== "undefined" && Buffer.isBuffer(a.content))
          return wk(new Uint8Array(a.content), r);
    ...
    if (!r.bookSheets && !r.bookProps) {
      ...
      if (r.cellStyles && i.themes.length)
        o = ah(zr(e, i.themes[0].replace(/^\//, ""), true) || "", r);
    ...
    if (r.bookDeps && i.calcchain)
      g = ug(Wr(e, sk(i.calcchain)), i.calcchain, r);
    var b = 0;
    var w = {};
    var k, T;
    {
          ...
          default:
            if (Array.isArray && Array.isArray(r.sheets)) {
              ...
              for (var I = 0; I != r.sheets.length; ++I) {
                ...
                if (
                  typeof r.sheets[I] == "string" &&
                  r.sheets[I].toLowerCase() == d.SheetNames[b].toLowerCase()
                )
                  R = 1;
              }
              if (!R) continue e;
    ...
    if (r && r.bookVBA) {
      ...
      else if (i.defaults && i.defaults.bin === jh)
        m.vbaraw = Wr(e, "xl/vbaProject.bin", true);
    }
  ...
  function wk(e, r) {
    ...
    if (typeof ArrayBuffer !== "undefined" && e instanceof ArrayBuffer)
      return wk(new Uint8Array(e), ((t = Tr(t)), (t.type = "array"), t));
    ...
    if (Xl.indexOf(i[0]) > -1 && i[2] <= 12 && i[3] <= 31)
      return $l.to_workbook(n, t);
    return bk(e, n, t, s);
  }
      ...
      for (var v = r.s.c; v <= r.e.c; ++v) {
        ...
        if (i[v] != null) {
          if (m == null) {
            ...
            u[i[v]] = (
              p.t === "n" && typeof s.rawNumbers === "boolean"
                ? s.rawNumbers
                : o
            )
              ? m
