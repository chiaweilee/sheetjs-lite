...
if (typeof module !== "undefined" && module.exports && typeof DO_NOT_EXPORT_CODEPAGE === "undefined") module.exports = cptable; (function(e, r) {
	"use strict";
...
function(e) {
	...
	if (h) {
				...
				if (typeof e === "string") {
					...
					for (i = 0; i < a; ++i) {
						...
						if (f < 128) n[s++] = t[f];
							...
							n[s++] = t[((f & 31) << 6) + (e[i + 1] & 63)]; ++i
						} else if (f < 240) {
							n[s++] = t[((f & 15) << 12) + ((e[i + 1] & 63) << 6) + (e[i + 2] & 63)];
							i += 2
						} else {
							l = ((f & 7) << 18) + ((e[i + 1] & 63) << 12) + ((e[i + 2] & 63) << 6) + (e[i + 3] & 63);
							i += 3;
							if (l < 65536) n[s++] = t[l];
							else {
								l -= 65536;
								n[s++] = t[55296 + (l >> 10 & 1023)];
								n[s++] = t[56320 + (l & 1023)]
							}
						}
					}
				...
				if (typeof e === "string") {
					...
					for (i = l = 0; i < t; ++i) {
						...
						if (o < 128) s = o;
							...
							s = ((o & 15) << 12) + ((e[i + 1] & 63) << 6) + (e[i + 2] & 63);
							i += 2
						} else {
							s = ((o & 7) << 18) + ((e[i + 1] & 63) << 12) + ((e[i + 2] & 63) << 6) + (e[i + 3] & 63);
							i += 3
						}
						if (s < 65536) {
							s *= 2;
			...
			return function o(e) {
				...
				if (Buffer.isBuffer(e)) {
					...
					for (n = 0; n < r; n++) {
						i = 2 * e.charCodeAt(n);
						if (a[i] === 255 && a[i + 1] === 253) {
							i = 2 * ((e.charCodeAt(n) << 8) + e.charCodeAt(n + 1)); ++n
						}
						t[s++] = a[i];
						t[s++] = a[i + 1]
					}
		...
		i[65001] = function z(e) {
			if (typeof e === "string") return z(e.split("").map(c));
			var r = e.length,
			t = 0,
			a = 0;
			if (4 * r > p) {
	...
	var I = function G(t, a, n) {
		...
		case "utf7":
			for (c = 0; c < i; c++) {
				...
				var k = G(1201, w);
				s[d++] = 43;
				s[d++] = S.charCodeAt(k[0] >> 2);
				s[d++] = S.charCodeAt(((k[0] & 3) << 4) + ((k[1] || 0) >> 4));
				s[d++] = S.charCodeAt(((k[1] & 15) << 2) + ((k[2] || 0) >> 6));
				s[d++] = 45
			}
			break;
		default:
		...
		s = s.slice(0, d);
		if (!h) return n == "str" ? s.map(o).join("") : s;
		if (!n || n === "buf") return s;
		if (n !== "arr") return s.toString("binary");
		return [].slice.call(s)
	};
	var N = function j(t, a) {
		var n;
		if (n = f[t]) return n(a);
		if (typeof a === "string") return j(t, a.split("").map(c));
		var i = a.length,
		s = new Array(i),
		l = "",
		o = 0,
		...
		if (m && (g = m.dec)) {
			for (u = 0; u < i; u += d) {
				...
				if (!l) throw new Error("Unrecognized code: " + a[u] + " " + a[u + d - 1] + " " + u + " " + d + " " + g[a[u]]);
				s[v++] = l
			}
		...
		case "utf8":
			...
			for (; u < i; u += d) {
				...
				if (a[u] < 128) o = a[u];
					...
					o = (a[u] & 31) * 64 + (a[u + 1] & 63);
					d = 2
				} else if (a[u] < 240) {
					o = ((a[u] & 15) << 12) + (a[u + 1] & 63) * 64 + (a[u + 2] & 63);
					d = 3
				} else {
					o = (a[u] & 7) * 262144 + ((a[u + 1] & 63) << 12) + (a[u + 2] & 63) * 64 + (a[u + 3] & 63);
					d = 4
				}
				if (o < 65536) {
					s[v++] = String.fromCharCode(o)
				} else {
					o -= 65536;
					p = 55296 + (o >> 10 & 1023);
					o = 56320 + (o & 1023);
		...
		case "utf32le":
			...
			d = 4;
			for (; u < i; u += d) {
				o = (a[u + 3] << 24) + (a[u + 2] << 16) + (a[u + 1] << 8) + a[u];
				if (o > 65535) {
					o -= 65536;
					s[v++] = String.fromCharCode(55296 + (o >> 10 & 1023));
					s[v++] = String.fromCharCode(56320 + (o & 1023))
				} else s[v++] = String.fromCharCode(o)
			}
			break;
		case "utf32be":
			...
			d = 4;
			for (; u < i; u += d) {
				o = (a[u] << 24) + (a[u + 1] << 16) + (a[u + 2] << 8) + a[u + 3];
				if (o > 65535) {
					o -= 65536;
					s[v++] = String.fromCharCode(55296 + (o >> 10 & 1023));
					s[v++] = String.fromCharCode(56320 + (o & 1023))
		...
		case "utf7":
			...
			for (; u < i; u += d) {
				...
				O = 0;
				for (var R = 1; R < d - w;) {
					C = S.indexOf(String.fromCharCode(a[u + R++]));
					_ = S.indexOf(String.fromCharCode(a[u + R++]));
					A = C << 2 | _ >> 4;
					k.push(A);
					x = S.indexOf(String.fromCharCode(a[u + R++]));
					if (x === -1) break;
					y = (_ & 15) << 4 | x >> 2;
					k.push(y);
					O = S.indexOf(String.fromCharCode(a[u + R++]));
					if (O === -1) break;
					E = (x & 3) << 6 | O;
					if (O < 64) k.push(E)
				}
...
function make_xlsx_lib(e) {
	...
	function x(e) {
		if (C) return Buffer.alloc ? Buffer.alloc(e) : new Buffer(e);
		return typeof Uint8Array != "undefined" ? new Uint8Array(e) : new Array(e)
	}
	function O(e) {
		if (C) return Buffer.allocUnsafe ? Buffer.allocUnsafe(e) : new Buffer(e);
		return typeof Uint8Array != "undefined" ? new Uint8Array(e) : new Array(e)
	}
	var R = function hT(e) {
		if (C) return _(e, "binary");
		return e.split("").map(function(e) {
			return e.charCodeAt(0) & 255
		})
	};
	function I(e) {
		if (typeof ArrayBuffer === "undefined") return R(e);
	...
	function(e) {
		return Buffer.concat(e.map(function(e) {
			return Buffer.isBuffer(e) ? e: _(e)
		}))
	}: function(e) {
		if (typeof Uint8Array !== "undefined") {
			...
			for (r = 0, t = 0; r < e.length; t += n, ++r) {
				...
				else if (typeof e[r] == "string") a.set(new Uint8Array(R(e[r])), t);
	...
	function te(e) {
		...
		if (r.indexOf("e") > -1) {
			...
			t = t.indexOf(".") > -1 ? t.slice(0, t.slice(0, 2) == "0." ? 17 : 16) : t.slice(0, 15) + Ar("0", t.length - 15);
	...
	function ve(e, r, t) {
		var a = r.replace(de, ""),
		n = r.length - a.length;
		return Fe(e, a, t * Math.pow(10, 2 * n)) + Ar("%", n)
	}
	function pe(e, r, t) {
		var a = r.length - 1;
	...
	function be(e, r, t) {
		...
		var s = n - i * a,
		f = a;
		return t + (i === 0 ? "": "" + i) + " " + (s === 0 ? Ar(" ", e[1].length + 1 + e[4].length) : z(s, e[1].length) + e[2] + "/" + e[3] + W(f, e[4].length))
	}
	function we(e, r, t) {
	...
	function xe(e, r, t) {
		...
		if (i = r.match(ge)) return be(i, l, o);
		if (r.match(/^#+0+$/)) return o + j(l, r.length - r.indexOf("0"));
		if (i = r.match(ke)) {
			n = Ee(t, i[1].length).replace(/^([^\.]+)$/, "$1." + ye(i[1])).replace(/\.$/, "." + ye(i[1])).replace(/\.(\d*)$/,
			function(e, r) {
				return "." + r + Ar("0", ye(i[1]).length - r.length)
			});
			return r.indexOf("0.") !== -1 ? n: n.replace(/^0\./, ".")
		}
		r = r.replace(/^#+([0.])/, "$1");
		if (i = r.match(/^(0*)\.(#*)$/)) {
			return o + Ee(l, i[2].length).replace(/\.(\d*[1-9])0*$/, ".$1").replace(/^(-?\d*)$/, "$1.").replace(/^0\./, i[1].length ? "0.": ".")
		}
		if (i = r.match(/^#{1,3},##0(\.?)$/)) return o + ue(j(l, 0));
		if (i = r.match(/^#,##0\.([#0]*0)$/)) {
			return t < 0 ? "-" + xe(e, r, -t) : ue("" + (Math.floor(t) + _e(t, i[1].length))) + "." + W(Ce(t, i[1].length), i[1].length)
		}
		if (i = r.match(/^#,#*,#0/)) return xe(e, r.replace(/^#,#*,/, ""), t);
		if (i = r.match(/^([0#]+)(\\?-([0#]+))+$/)) {
			n = B(xe(e, r.replace(/[\\-]/g, ""), t));
			s = 0;
		...
		if (i = r.match(/^# ([#0?]+)( ?)\/( ?)([#0?]+)/)) {
			...
			return o + (f[0] || (f[1] ? "": "0")) + " " + (f[1] ? z(f[1], s) + i[2] + "/" + i[3] + H(f[2], s) : Ar(" ", 2 * s + 1 + i[2].length + i[3].length))
		}
		if (i = r.match(/^[#0?]+$/)) {
			n = j(t, 0);
		...
		if (i = r.match(/^00,000\.([#0]*0)$/)) {
			s = Ce(t, i[1].length);
			return t < 0 ? "-" + xe(e, r, -t) : ue(Se(t)).replace(/^\d,\d{3}$/, "0$&").replace(/^\d*$/,
			function(e) {
	...
	function Ne(e, r, t) {
		...
		if (r.charCodeAt(r.length - 1) === 44) return Oe(e, r, t);
		...
		if (i = r.match(ge)) return we(i, l, o);
		...
		if (i = r.match(/^#{1,3},##0(\.?)$/)) return o + ue("" + l);
		if (i = r.match(/^#,##0\.([#0]*0)$/)) {
			return t < 0 ? "-" + Ne(e, r, -t) : ue("" + t) + "." + Ar("0", i[1].length)
		}
		...
		if (i = r.match(/^00,000\.([#0]*0)$/)) {
			return t < 0 ? "-" + Ne(e, r, -t) : ue("" + t).replace(/^\d,\d{3}$/, "0$&").replace(/^\d*$/,
			function(e) {
				return "00," + (e.length < 3 ? W(0, 3 - e.length) : "") + e
			}) + "." + W(0, i[1].length)
		}
		...
		case "#,###":
			...
			return d !== "0" ? o + d: "";
		default:
			if (r.match(/\.[0#?]*$/)) return Ne(e, r.slice(0, r.lastIndexOf(".")), t) + ye(r.slice(r.lastIndexOf(".")));
		}
		throw new Error("unsupported format |" + r + "|")
	}
	function Fe(e, r, t) {
		return (t | 0) === t ? Ne(e, r, t) : xe(e, r, t)
	}
	function De(e) {
		var r = [];
		var t = false;
	...
	function Me(e, r, t, a) {
		...
		for (s = 0; s < n.length; ++s) {
			...
			case "b":
				;
			case "Z":
				n[s].v = he(n[s].t.charCodeAt(0), n[s].v, o, g);
				n[s].t = "t";
				break;
			case "n":
				;
		...
		if (k.length > 0) {
			...
			if (C === n.length && E.indexOf("E") === -1) {
				for (s = n.length - 1; s >= 0; --s) {
					...
					if (T >= n[s].v.length - 1) {
						T -= n[s].v.length;
						n[s].v = E.substr(T + 1, n[s].v.length)
					} else if (T < 0) n[s].v = "";
					else {
						n[s].v = E.substr(0, T + 1);
						T = -1
					}
					n[s].t = "t";
					_ = s
				}
				if (T >= 0 && _ < n.length) n[_].v = E.substr(0, T + 1) + n[_].v
				...
				for (s = C; s >= 0; --s) {
					...
					A = n[s].v.substr(c + 1);
					for (; c >= 0; --c) {
						if (T >= 0 && (n[s].v.charAt(c) === "0" || n[s].v.charAt(c) === "#")) A = E.charAt(T--) + A
					}
					n[s].v = A;
					n[s].t = "t";
					_ = s
		...
		for (s = 0; s < n.length; ++s) if (n[s] != null && "n?".indexOf(n[s].t) > -1) {
			y = a > 1 && r < 0 && s > 0 && n[s - 1].v === "-" ? -r: r;
			n[s].v = Fe(n[s].t, n[s].v, y);
			n[s].t = "t"
		}
		var S = "";
	...
	var qe = function() {
		...
		function T(e, r) {
			...
			n = e.length - 15,
			k = 0;
			for (; k < n;) a = w[e[k++] ^ a & 255] ^ b[e[k++] ^ a >> 8 & 255] ^ g[e[k++] ^ a >> 16 & 255] ^ m[e[k++] ^ a >>> 24] ^ p[e[k++]] ^ v[e[k++]] ^ d[e[k++]] ^ u[e[k++]] ^ h[e[k++]] ^ c[e[k++]] ^ o[e[k++]] ^ l[e[k++]] ^ f[e[k++]] ^ s[e[k++]] ^ i[e[k++]] ^ t[e[k++]];
			n += 15;
	...
	var Qe = function dT() {
		...
		function o(e, r) {
			...
			p(l, i, y, a, o);
			var E = g(y, s, o, a);
			if (s < E.length) E[s].name = "!Directory";
			if (n > 0 && f !== L) E[f].name = "!MiniFAT";
			E[o[0]].name = "!FAT";
			E.fat_addrs = o;
			E.ssz = a;
			var C = {},
			...
			for (; h < c.length; h += 128) {
				...
				if (g.type === 5) {
					...
					if (g.size < 0) g.size = 0;
						...
						g.content = v(g, r[l].data, (r[f] || {}).data)
					}
				}
				if (g.content) Ta(g.content, 0);
				i[d] = g;
				s.push(g)
			}
		}
		...
		function A(e, r) {
			var t = r && r.type;
			if (!t) {
				if (C && Buffer.isBuffer(e)) t = "buffer"
			}
			switch (t || "base64") {
			case "file":
				return k(e, r);
		...
		function N(e, r) {
			...
			var a = function(e) {
				...
				while (o + c + h + 127 >> 7 > c) h = ++c <= 109 ? 0 : Math.ceil((c - 109) / 127);
				var u = [1, h, c, l, s, t, r, 0];
			...
			for (i = 1; i < e.FileIndex.length; ++i) {
				...
				if (c.size >= 4096) {
					n.l = c.start + 1 << 9;
					if (C && Buffer.isBuffer(c.content)) {
		...
		function $(e, r) {
			...
			case "base64":
				return T(typeof t == "string" ? t: X(t));
			case "buffer":
				if (C) return Buffer.isBuffer(t) ? t: _(t);
			case "array":
				return typeof t == "string" ? R(t) : t;
			}
			return t
		}
		var G;
		...
		function Se(e, r) {
			...
			for (u = 0; u < h; ++u) {
				...
				if (v != 0) {
					d = re[f[u]] >> 8 - v;
					for (var p = (1 << 7 - v) - 1; p >= 0; --p) Ee[d | p << v] = v & 7 | u << 3
				}
			}
			var m = [];
			l = 1;
		...
		function Ne(e, r, t, a, n) {
			...
			if (v) {
				var g = s(e.slice(e.l, e.l + v));
				if ((g[21589] || {}).mt) o = g[21589].mt;
		...
		function Fe(e, r) {
			...
			for (c = 1; c < e.FullPaths.length; ++c) {
				...
				var T = typeof m.content == "string" ? R(m.content) : m.content;
				if (f == 8) T = Y(T);
				s = ya(30);
				s._W(4, 67324752);
				s._W(2, 20);
		...
		function We(e, r) {
			if (X(e.slice(0, 13)).toLowerCase() != "mime-version:") throw new Error("Unsupported MAD header");
			var t = r && r.root || "";
			var a = (C && Buffer.isBuffer(e) ? e.toString("binary") : X(e)).split("\r\n");
			var n = 0,
			i = "";
		...
		function ze(e, r) {
			...
			for (var l = 1; l < e.FullPaths.length; ++l) {
				...
				var o = f.content;
				var c = C && Buffer.isBuffer(o) ? o.toString("binary") : X(o);
				var h = 0,
	...
	function ar(e, r, t) {
		...
		if (typeof Blob !== "undefined") {
			...
			if (typeof URL !== "undefined" && typeof document !== "undefined" && document.createElement && URL.createObjectURL) {
				...
				var f = "data:application/octet-stream;base64," + y(new Uint8Array(tr(a)));
				return chrome.downloads.download({
					url: f,
					filename: e,
					saveAs: true
	...
	var hr = Date.UTC(1899, 11, 31, 0, 0, 0);
	...
	function wr(e, r) {
		...
		var t = e.match(mr);
		if (t) return new Date((r ? ur: hr) + ((parseInt(t[1], 10) * 60 + parseInt(t[2], 10)) * 60 + (t[3] ? parseInt(t[3].slice(1), 10) : 0)) * 1e3 + (t[4] ? parseInt((t[4] + "000").slice(1, 4), 10) : 0));
		t = e.match(gr);
	...
	var Er = /^(0?\d|1[0-2])(?:|:([0-5]?\d)(?:|(\.\d+)(?:|:([0-5]?\d))|:([0-5]?\d)(|\.\d+)))\s+([ap])m?$/;
	var Cr = /^([01]?\d|2[0-3])(?:|:([0-5]?\d)(?:|(\.\d+)(?:|:([0-5]?\d))|:([0-5]?\d)(|\.\d+)))$/;
	var _r = /^(\d+)-(\d+)-(\d+)[T ](\d+):(\d+)(:\d+)(\.\d+)?[Z]?$/;
	var Sr = new Date("6/9/69 00:00 UTC").valueOf() == -177984e5;
	function xr(e) {
	...
	function Ir(e) {
		if (_r.test(e)) return e.indexOf("Z") == -1 ? Dr(new Date(e)) : new Date(e);
		var r = e.toLowerCase();
		...
		var n = new Date(Sr && e.indexOf("UTC") == -1 ? e + " UTC": e),
		i = new Date(NaN);
		var s = n.getYear(),
		f = n.getMonth(),
		l = n.getDate();
		...
		if (r.match(/jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec/)) {
			...
			if (r.length > 3 && Rr.indexOf(r) == -1) return i
	...
	function Pr(e) {
		...
		if (e.asNodeBuffer && C) return v(e.asNodeBuffer().toString("binary"));
	...
	function bt(e) {
		return _(e, "binary").toString("utf8")
	}
	var wt = "foo bar bazâð£";
	var kt = C && (bt(wt) == mt(wt) && bt || gt(wt) == mt(wt) && gt) || mt;
	var Tt = C ?
	function(e) {
		return _(e, "utf8").toString("binary")
	}: function(e) {
		var r = [],
		t = 0,
		a = 0,
	...
	var xt = /(^\s|\s$|\n)/;
	function Ot(e, r) {
		return "<" + e + (r.match(xt) ? ' xml:space="preserve"': "") + ">" + r + "</" + e + ">"
	}
	function Rt(e) {
	...
	function It(e, r, t) {
		return "<" + e + (t != null ? Rt(t) : "") + (r != null ? (r.match(xt) ? ' xml:space="preserve"': "") + ">" + r + "</" + e: "/") + ">"
	}
	function Nt(e, r) {
		try {
	...
	var Xt = C ?
	function(e, r, t) {
		if (!Buffer.isBuffer(e) || !S) return Vt(e, r, t);
	...
	var Gt = C ?
	function(e, r, t) {
		return Buffer.isBuffer(e) ? e.toString("hex", r, r + t) : $t(e, r, t)
	}: $t;
	...
	if (C) {
		...
		ea = function wT(e, r) {
			if (!Buffer.isBuffer(e) || !S) return Qt(e, r);
			var t = 2 * e.readUInt32LE(r);
			return e.toString("utf16le", r + 4, r + 4 + t - 1)
		};
		ta = function kT(e, r) {
			if (!Buffer.isBuffer(e) || !S) return ra(e, r);
			var t = e.readUInt32LE(r);
	...
	function pa(e, t) {
		...
		case "dbcs":
			h = this.l;
			if (C && Buffer.isBuffer(this) && S) n = this.slice(this.l, this.l + 2 * e).toString("utf16le");
			else for (c = 0; c < e; ++c) {
				n += String.fromCharCode(ca(this, h));
				h += 2
			}
			e *= 2;
			break;
	...
	function wa(e, n, i) {
		...
		f = 0;
		if (i === "dbcs") {
			for (f = 0; f != n.length; ++f) ba(this, n.charCodeAt(f), this.l + 2 * f);
			s = 2 * n.length
	...
	function Ra(e, r) {
		...
		return Oa(e.s, r.biff) + ":" + Oa(e.e, r.biff)
	}
	...
	function Ja(e, r, t) {
		...
		for (var u = 0; u != r.length; ++u) {
			...
			for (var p = 0; p != r[u].length; ++p) {
				if (typeof r[u][p] === "undefined") continue;
				var m = {
					v: r[u][p]
				};
				var g = f + p;
				...
				if (o.e.r < d) o.e.r = d;
				if (o.e.c < g) o.e.c = g;
				if (r[u][p] && typeof r[u][p] === "object" && !Array.isArray(r[u][p]) && !(r[u][p] instanceof Date)) m = r[u][p];
				else {
	...
	function ki(e) {
		...
		for (var t = 0; t != e.length; ++t) {
			r.push(bi(e[t][0], e[t][1]));
			r.push(wi("", e[t][0]))
		}
		r.push(bi("", "Document", "pkg"));
		r.push("</rdf:RDF>");
		return r.join("")
	}
	function Ti(r, t) {
	...
	var Ai = [["cp:category", "Category"], ["cp:contentStatus", "ContentStatus"], ["cp:keywords", "Keywords"], ["cp:lastModifiedBy", "LastAuthor"], ["cp:lastPrinted", "LastPrinted"], ["cp:revision", "RevNumber"], ["cp:version", "Version"], ["dc:creator", "Author"], ["dc:description", "Comments"], ["dc:identifier", "Identifier"], ["dc:language", "Language"], ["dc:subject", "Subject"], ["dc:title", "Title"], ["dcterms:created", "CreatedDate", "date"], ["dcterms:modified", "ModifiedDate", "date"]];
	var yi = function() {
		var e = new Array(Ai.length);
	...
	function Ci(e, r, t, a, n) {
		if (n[e] != null || r == null || r === "") return;
		n[e] = r;
		r = lt(r);
		a[a.length] = t ? It(e, r, t) : Ot(e, r)
	}
	function _i(e, r) {
		var t = r || {};
		...
		if (e) {
			if (e.CreatedDate != null) Ci("dcterms:created", typeof e.CreatedDate === "string" ? e.CreatedDate: Nt(e.CreatedDate, t.WTF), {
				"xsi:type": "dcterms:W3CDTF"
			},
			a, n);
			if (e.ModifiedDate != null) Ci("dcterms:modified", typeof e.ModifiedDate === "string" ? e.ModifiedDate: Nt(e.ModifiedDate, t.WTF), {
				"xsi:type": "dcterms:W3CDTF"
			},
			a, n)
		}
	...
	var Si = [["Application", "Application", "string"], ["AppVersion", "AppVersion", "string"], ["Company", "Company", "string"], ["DocSecurity", "DocSecurity", "string"], ["Manager", "Manager", "string"], ["HyperlinksChanged", "HyperlinksChanged", "bool"], ["SharedDoc", "SharedDoc", "bool"], ["LinksUpToDate", "LinksUpToDate", "bool"], ["ScaleCrop", "ScaleCrop", "bool"], ["HeadingPairs", "HeadingPairs", "raw"], ["TitlesOfParts", "TitlesOfParts", "raw"]];
	var xi = ["Worksheets", "SheetNames", "NamedRanges", "DefinedNames", "Chartsheets", "ChartNames"];
	function Oi(e, r, t, a) {
		var n = [];
		...
		var s = typeof r == "string" ? St(r, a).map(function(e) {
			return e.v
		}) : r;
		var f = 0,
		l = 0;
	...
	function Ri(e, r, t) {
		...
		if (a.HeadingPairs && a.TitlesOfParts) Oi(a.HeadingPairs, a.TitlesOfParts, r, t);
		return r
	}
	function Ii(e) {
		var r = [],
	...
	function Ui(e, r) {
		...
		ir(Pi).map(function(e) {
			for (var r = 0; r < Ai.length; ++r) if (Ai[r][1] == e) return Ai[r];
			for (r = 0; r < Si.length; ++r) if (Si[r][1] == e) return Si[r];
			throw e
		}).forEach(function(a) {
	...
	function Bi(e, r) {
		...
		if (e) ir(e).forEach(function(r) {
			...
			for (var a = 0; a < Ai.length; ++a) if (r == Ai[a][1]) return;
	...
	function rs(e, r) {
		...
		case 31:
			;
		case 80:
			a = ya(4 + 2 * (r.length + 1) + (r.length % 2 ? 0 : 2));
			a._W(4, r.length + 1);
			a._W(0, r, "dbcs");
	...
	function is(e, r, t) {
		...
		if (!r) {
			...
			for (f = 0; f < e.length; ++f) {
				var h = e[f][0];
				l = ya(4 + 4 + 2 * (h.length + 1) + (h.length % 2 ? 0 : 2));
				l._W(4, f + 2);
				l._W(4, h.length + 1);
				l._W(0, h, "dbcs");
		...
		for (f = 0; f < e.length; ++f) {
			...
			if (as.indexOf(e[f][0]) > -1 || xi.indexOf(e[f][0]) > -1) continue;
	...
	function Is(e, r) {
		...
		var i, s, f, l, o = "",
		c, h;
		if (n & 16) i = Os(e, t - e.l);
		if (n & 128) s = Os(e, t - e.l);
		if ((n & 257) === 257) f = Os(e, t - e.l);
		if ((n & 257) === 1) l = xs(e, t - e.l);
		if (n & 8) o = Os(e, t - e.l);
		if (n & 32) c = e._R(16);
		if (n & 64) h = Wi(e);
		e.l = t;
	...
	function _f(e, r, t, a) {
		var n = t && t.biff == 5;
		if (!a) a = ya(n ? 3 + r.length: 5 + 2 * r.length);
		a._W(2, e);
		a._W(n ? 1 : 2, r.length);
		if (!n) a._W(1, 1);
	...
	function Qf(e, r, t) {
		...
		var c = a - e.l;
		if (t && t.biff == 2)--c;
		var h = a == e.l || f === 0 || !(c > 0) ? [] : Wd(e, c, t, f);
		return {
			chKey: i,
			Name: o,
			itab: l,
	...
	function vl(e, r, t) {
		...
		try {
			...
			for (var o = 1; o < e.lens.length - 1; ++o) {
				...
				var c = e[e.l];
				var h = Ts(e, e.lens[o + 1] - e.lens[o] - 1);
				n += h;
	...
	var $l = function() {
		...
		function i(r, t) {
			...
			var v = [],
			p = {};
			var m = Math.min(i.length, s == 2 ? 521 : h - 10 - (l ? 264 : 0));
			var g = o ? 32 : 11;
			while (i.l < m && i[i.l] != 13) {
				p = {};
				p.name = (typeof a !== "undefined" ? a.utils.decode(d, i.slice(i.l, i.l + g)) : N(i.slice(i.l, i.l + g))).replace(/[\u0000\r\n].*$/g, "");
				i.l += g;
			...
			while (c-->0) {
				...
				for (w = 0; w != v.length; ++w) {
					...
					switch (v[w].type) {
					case "C":
						if (T.trim().length) n[b][w] = T.replace(/\s+$/, "");
						break;
					case "D":
						if (T.length === 8) {
							n[b][w] = new Date(Date.UTC( + T.slice(0, 4), +T.slice(4, 6) - 1, +T.slice(6, 8), 0, 0, 0, 0));
							if (! (t && t.UTC)) {
								n[b][w] = Fr(n[b][w])
							}
						} else n[b][w] = T;
						break;
					case "F":
						n[b][w] = parseFloat(T.trim());
						break;
					case "+":
						;
					case "I":
						n[b][w] = o ? k._R(-4, "i") ^ 2147483648 : k._R(4, "i");
						break;
					case "L":
					...
					case "M":
						...
						n[b][w] = "##MEMO##" + (o ? parseInt(T.trim(), 10) : k._R(4));
						break;
					case "N":
						T = T.replace(/\u0000/g, "").trim();
						if (T && T != ".") n[b][w] = +T || 0;
					...
					case "T":
						{
							...
							y = k._R(4);
							if (A == 0 && y == 0) break;
							n[b][w] = new Date((A - 2440588) * 864e5 + y);
							if (! (t && t.UTC)) n[b][w] = Fr(n[b][w])
						}
						break;
					case "Y":
		...
		function c(i, s) {
			...
			for (m = 0; m <= k.e.c - k.s.c; ++m) {
				...
				for (g = 0; g < v.length; ++g) {
					if (v[g][m] != null) S.push(v[g][m])
				}
				if (S.length == 0 || d[m] == null) {
					T[m] = "?";
					continue
				}
				for (g = 0; g < S.length; ++g) {
					...
					case "boolean":
						...
						break;
					case "object":
						C = S[g] instanceof Date ? "D": "C";
						break;
					default:
						C = "C";
					}
					_ = Math.max(_, (typeof a !== "undefined" && typeof S[g] == "string" ? a.utils.encode(t, S[g]) : String(S[g])).length);
					E = E && E != C ? "C": C
				}
				if (_ > 250) _ = 250;
				C = ((p[m] || {}).DBF || {}).type;
				if (C == "C") {
					if (p[m].DBF.len > _) _ = p[m].DBF.len
				}
				if (E == "B" && C == "N") {
					E = "N";
					y[m] = p[m].DBF.dec;
			...
			for (m = 0; m < v.length; ++m) {
				...
				for (g = 0; g < d.length; ++g) {
					...
					switch (T[g]) {
					case "L":
						F._W(1, v[m][g] == null ? 63 : v[m][g] ? 84 : 70);
						break;
					case "B":
						F._W(8, v[m][g] || 0, "f");
						break;
					case "N":
						var D = "0";
						if (typeof v[m][g] == "number") D = v[m][g].toFixed(y[g] || 0);
						if (D.length > A[g]) D = D.slice(0, A[g]);
						for (b = 0; b < A[g] - D.length; ++b) F._W(1, 32);
						F._W(1, D, "sbcs");
						break;
					case "D":
						if (!v[m][g]) F._W(8, "00000000", "sbcs");
						else {
							F._W(4, ("0000" + v[m][g].getFullYear()).slice(-4), "sbcs");
							F._W(2, ("00" + (v[m][g].getMonth() + 1)).slice(-2), "sbcs");
							F._W(2, ("00" + v[m][g].getDate()).slice(-2), "sbcs")
						}
						break;
					case "C":
						var P = F.l;
						var L = String(v[m][g] != null ? v[m][g] : "").slice(0, A[g]);
						F._W(1, L, "cpstr");
						P += A[g] - F.l;
	...
	var Gl = function() {
		...
		function f(e, r) {
			...
			case "binary":
				return o(e, r);
			case "buffer":
				return o(C && Buffer.isBuffer(e) ? e.toString("binary") : N(e), r);
			case "array":
				return o(kr(e), r);
			}
			throw new Error("Unrecognized type " + r.type)
		...
		function o(e, t) {
			...
			for (; c !== s.length; ++c) {
				w = 0;
				var A = s[c].trim().replace(/\x1B([\x20-\x2F])([\x30-\x3F])/g, i).replace(r, n);
				var y = A.replace(/;;/g, "\0").split(";").map(function(e) {
					return e.replace(/\u0000/g, ";")
				});
				var E = y[0],
				C;
				if (A.length > 0) switch (E) {
				case "ID":
					break;
				case "E":
					break;
				case "B":
					break;
				case "O":
					for (h = 1; h < y.length; ++h) switch (y[h].charAt(0)) {
					case "V":
						{
							var _ = parseInt(y[h].slice(1), 10);
							if (_ >= 1 && _ <= 4) T.Workbook.WBProps.date1904 = true
						}
						break;
					}
					break;
				...
				case "NN":
					{
						...
						case "N":
							...
							break;
						case "E":
							S.Ref = (t && t.sheet || "Sheet1") + "!" + ru(y[h].slice(1));
							break;
						}
						T.Workbook.Names.push(S)
					}
					break;
				case "C":
					var x = false,
					...
					case "A":
						...
						break;
					case "X":
						o = parseInt(y[h].slice(1), 10) - 1;
						O = true;
						break;
					case "Y":
						f = parseInt(y[h].slice(1), 10) - 1;
						if (!O) o = 0;
					...
					case "K":
						...
						if (C.charAt(0) === '"') {
							...
							if (v !== null && Le(v) && t.cellDates) {
								C = vr(T.Workbook.WBProps.date1904 ? C + 1462 : C);
								P = typeof C == "number" ? "n": "d"
							}
						}
						if (typeof a !== "undefined" && typeof C == "string" && (t || {}).type != "string" && (t || {}).codepage) C = a.utils.decode(t.codepage, C);
						x = true;
						break;
					case "E":
						I = true;
					...
					case "G":
						break;
					case "R":
						N = parseInt(y[h].slice(1), 10) - 1;
						break;
					case "C":
						F = parseInt(y[h].slice(1), 10) - 1;
						break;
					default:
						if (t && t.WTF) throw new Error("SYLK bad record " + A);
					}
					if (x) {
						if (!u[f][o]) u[f][o] = {
							t: P,
						...
						if (v) u[f][o].z = v;
						if (t.cellText !== false && v) u[f][o].w = ze(u[f][o].z, u[f][o].v, {
			...
			if (t && t.sheetRows) u = u.slice(0, t.sheetRows);
			return [u, p, T]
		}
		function c(e, r) {
			var t = f(e, r);
		...
		function h(e, r, t, a, n, i) {
			var s = "C;Y" + (t + 1) + ";X" + (a + 1) + ";K";
			switch (e.t) {
			case "n":
				s += e.v || 0;
				if (e.f && !e.F) s += ";E" + nu(e.f, {
					r: t,
					c: a
				});
				break;
			...
			if (e["!ref"]) for (p = i.s.r; p <= i.e.r; ++p) {
				...
				for (m = i.s.c; m <= i.e.c; ++m) {
					...
					if ((s.z || (s.t == "d" ? q[14] : "General")) != c) {
						...
						g.push("F;P" + b + ";Y" + (p + 1) + ";X" + (m + 1))
					}
					g.push(h(s, e, p, m, r, o))
				}
				n.push(g.join(l))
			}
	...
	var jl = function() {
		function e(e, t) {
			...
			case "binary":
				return r(e, t);
			case "buffer":
				return r(C && Buffer.isBuffer(e) ? e.toString("binary") : N(e), t);
			case "array":
				return r(kr(e), t);
			}
			...
			for (var f = t.s.r; f <= t.e.r; ++f) {
				...
				for (var c = t.s.c; c <= t.e.c; ++c) {
					...
					case "n":
						if (r) {
							if (h.w != null) o += "0," + h.w + "\r\nV";
							else if (h.v != null) o += n(h.v, "V");
							else if (h.f != null && !h.F) o += i("=" + h.f);
							else o += '1,0\r\n""'
						} else {
							if (h.v == null) o += '1,0\r\n""';
							else o += n(h.v, "V")
						...
						break;
					case "b":
						o += h.v ? n(1, "TRUE") : n(0, "FALSE");
						break;
					case "s":
						o += i(!r || isNaN( + h.v) ? h.v: '="' + h.v + '"');
						break;
					case "d":
						if (!h.w) h.w = ze(h.z || q[14], dr(wr(h.v)));
						if (r) o += n(h.w, "V");
						else o += i(h.w);
						break;
					default:
	...
	var Yl = function() {
		...
		function l(e, r) {
			var t = "",
			n = r.type == "string" ? [0, 0, 0, 0] : hk(e, r);
			switch (r.type) {
			case "base64":
				t = E(e);
				break;
			...
			case "buffer":
				...
				else t = C && Buffer.isBuffer(e) ? e.toString("binary") : N(e);
				break;
			case "array":
				t = kr(e);
				break;
	...
	var Jl = function() {
		...
		function a(r, a) {
			if (!r) return r;
			var n = a || {};
			if (b != null && n.dense == null) n.dense = b;
			var i = {},
			s = "Sheet1",
			f = "",
			l = 0;
			...
			if (r[2] == 2) {
				...
				function(e, r, a) {
					...
					case 16:
						...
						var h = n.dense ? (u[e[0].r] || [])[e[0].c] : i[za(e[0])];
						if (h) {
							h.t = e[1].t;
							h.v = e[1].v;
							if (e[1].z != null) h.z = e[1].z;
							if (e[1].f != null) h.f = e[1].f;
							p = h;
							break
						}
						if (n.dense) {
			...
			var m = {},
			g = [];
			for (var w = 0; w < h.length; ++w) if (o[c[w]]) {
				g.push(h[w] || c[w]);
				m[h[w]] = o[h[w]] || o[c[w]]
			} else {
				g.push(h[w]);
		...
		function n(e, r) {
			...
			for (var h = n.s.c; h <= n.e.c; ++h) f[h] = La(h);
			for (var u = n.s.r; u <= o; ++u) {
				var d = Na(u);
				for (h = n.s.c; h <= n.e.c; ++h) {
					var p = i ? (e["!data"][u] || [])[h] : e[f[h] + d];
					if (!p || p.t == "z") continue;
					switch (p.t) {
					case "n":
						if ((p.v | 0) == p.v && p.v >= -32768 && p.v <= 32767) rb(a, 13, g(u, h, p));
						else rb(a, 14, k(u, h, p));
						break;
					case "d":
						var m = dr(p.v);
						if ((m | 0) == m && m >= -32768 && m <= 32767) rb(a, 13, g(u, h, {
							t: "n",
							v: m,
							z: p.z || q[14]
						}));
		...
		function i(e, r) {
			...
			rb(a, 0, f(e));
			for (var n = 0,
			i = 0; n < e.SheetNames.length; ++n) if ((e.Sheets[e.SheetNames[n]] || {})["!ref"]) rb(a, 27, H(e.SheetNames[n], i++));
			var s = 0;
			for (n = 0; n < e.SheetNames.length; ++n) {
				...
				for (var v = c.s.r; v <= d; ++v) {
					...
					for (var m = c.s.c; m <= c.e.c; ++m) {
						if (v === c.s.r) u[m] = La(m);
						var g = u[m] + p;
						var b = h ? (o["!data"][v] || [])[m] : o[g];
						if (!b || b.t == "z") continue;
						if (b.t == "n") {
							rb(a, 23, F(v, m, s, b.v))
						} else {
							var w = Ka(b);
							rb(a, 22, O(v, m, s, w.slice(0, 239)))
						}
					}
				}++s
			}
		...
		function _(e, r) {
			...
			while (e.l < e.length) {
				...
				case 1:
					{
						i = A(r[0].c, e._R(2), true);
						n = A(r[0].r, e._R(2), false);
						t.push(i + n)
					}
					break;
				case 2:
					{
						var o = A(r[0].c, e._R(2), true);
						var c = A(r[0].r, e._R(2), false);
						i = A(r[0].c, e._R(2), true);
						n = A(r[0].r, e._R(2), false);
						t.push(o + c + ":" + i + n)
					}
				...
				case 6:
					{
						var h = "";
						while (l = e[e.l++]) h += String.fromCharCode(l);
						t.push('"' + h.replace(/"/g, '""') + '"')
					}
					break;
				case 8:
		...
		function j(e, r) {
			...
			e: while (e.l < e.length) {
				...
				case 10:
					{
						var g = m._R(4);
						var w = (m.length - m.l) / g | 0;
						for (var k = 0; k < g; ++k) {
							var T = m.l + w;
							var A = {};
							m.l += 2;
							A.numFmtId = m._R(2);
							if ($[A.numFmtId]) A.z = $[A.numFmtId];
							m.l = T;
							d.push(A)
						}
					}
				...
				case 3073:
					{
						...
						while (m.l < m.length) {
							...
							case 8:
								...
								break;
							default:
								throw "Unrecognized QPW cell type " + (_ & 31);
							}
							if (S != -1 && (d[S - 1] || {}).z) C.z = d[S - 1].z;
							var O = 0;
							if (_ & 32) switch (_ & 31) {
							case 2:
								O = m._R(2);
							...
							case 7:
								...
								break;
							default:
								throw "Unsupported delta for QPW cell type " + (_ & 31);
							}
							if (! (!t.sheetStubs && C.t == "z")) {
								var R = Tr(C);
								if (C.t == "n" && C.z && Le(C.z) && t.cellDates) {
									R.v = vr(C.v);
									R.t = typeof R.v == "number" ? "n": "d"
								}
								if (a["!data"] != null) {
									if (!a["!data"][h]) a["!data"][h] = [];
									a["!data"][h][c] = R
								} else a[E + Na(h)] = R
							}++h; --l;
							while (x-->0 && l >= 0) {
								...
								case 7:
									...
									break;
								default:
									throw "Cannot apply delta for QPW cell type " + (_ & 31);
								} else switch (_ & 31) {
								case 1:
									C = {
										t: "z"
								...
								case 7:
									...
									break;
								default:
									throw "Cannot apply repeat for QPW cell type " + (_ & 31);
								}
								if (S != -1);
								if (! (!t.sheetStubs && C.t == "z")) {
									if (a["!data"] != null) {
	...
	function mo(e) {
		var r = Ca();
		_a(r, 159, vo(e));
		for (var t = 0; t < e.length; ++t) _a(r, 19, po(e[t]));
		_a(r, 160);
		return r.end()
	}
	function go(e) {
	...
	function Io(e, r) {
		var t = {};
		var a = t.EncryptionVersionInfo = bo(e, 4);
		r -= 4;
		...
		var n = e._R(4);
		r -= 4;
		t.EncryptionHeader = Co(e, n);
		r -= n;
		t.EncryptionVerifier = _o(e, r);
		return t
	}
	function No(e) {
		var r = {};
		var t = r.EncryptionVersionInfo = bo(e, 4);
	...
	function Wo(e, r) {
		...
		case "binary":
			return zo(e, r);
		case "buffer":
			return zo(C && Buffer.isBuffer(e) ? e.toString("binary") : N(e), r);
		case "array":
			return zo(kr(e), r);
		}
		throw new Error("Unrecognized type " + r.type)
	...
	function zo(e, r) {
		...
		i.forEach(function(e, r) {
			...
			while ((o = i.exec(e)) != null) {
				var u = e.slice(l, i.lastIndex - o[0].length);
				if (u.charCodeAt(0) == 32) u = u.slice(1);
				if (u.length) h.push(u);
				switch (o[0]) {
				case "\\cell":
					++c;
					if (h.length) {
	...
	var wc = function CT() {
		...
		return function i(s, f, l) {
			...
			if (c = s.match(a)) uc(c, o, f, l);
			if (c = s.match(t)) hc(c, o, f, l);
			if (c = s.match(n)) cc(c, o, f, l);
			if (c = s.match(r)) gc(c, o, l);
			return o
		}
	} ();
	function kc(e, r) {
		...
		if (a = bc(r.cellXfs)) t[t.length] = a;
	...
	var Cc = ["none", "solid", "mediumGray", "darkGray", "lightGray", "darkHorizontal", "darkVertical", "darkDown", "darkUp", "darkGrid", "darkTrellis", "lightHorizontal", "lightVertical", "lightDown", "lightUp", "lightGrid", "lightTrellis", "gray125", "gray0625"];
	var _c;
	var Sc = Aa;
	function xc(e, r) {
		if (!r) r = ya(4 * 3 + 8 * 7 + 16 * 1);
		if (!_c) _c = fr(Cc);
		var t = _c[e.patternType];
		if (t == null) t = 40;
		r._W(4, t);
		var a = 0;
		if (t != 40) {
	...
	function Mc(e, r) {
		...
		if (t == 0) return;
		_a(e, 615, en(t)); [[5, 8], [23, 26], [41, 44], [50, 392]].forEach(function(t) {
			for (var a = t[0]; a <= t[1]; ++a) if (r[a] != null) _a(e, 44, Ac(a, r[a]))
		});
		_a(e, 616)
	}
	function Uc(e) {
	...
	function $c(e) {
		var r = 0;
		_a(e, 508, Pc(r, "TableStyleMedium9", "PivotStyleMedium4"));
		_a(e, 509)
	}
	function Gc() {
		return
	...
	var eh = /<a:fmtScheme([^>]*)>[\s\S]*<\/a:fmtScheme>/;
	function rh(e, r, t) {
		r.themeElements = {};
		var a; [["clrScheme", qc, Yc], ["fontScheme", Qc, Zc], ["fmtScheme", eh, Jc]].forEach(function(n) {
			if (! (a = e.match(n[1]))) throw new Error(n[0] + " not found in themeElements");
			n[2](a, r, t)
		})
	}
	var th = /<a:themeElements([^>]*)>[\s\S]*<\/a:themeElements>/;
	function ah(e, r) {
		if (!e || e.length === 0) e = nh();
		var t;
		var a = {};
		if (! (t = e.match(th))) throw new Error("themeElements not found in theme");
		rh(t[0], a, r);
		a.raw = e;
		return a
	}
	...
	var Rh = /<(?:\w+:)?shape(?:[^\w][^>]*)?>([\s\S]*?)<\/(?:\w+:)?shape>/g;
	function Ih(e, r, t) {
		var a = 0; (e.match(Rh) || []).forEach(function(e) {
			var n = "";
			var i = true;
			var s = -1;
			var f = -1,
	...
	function Fh(e, r, t) {
		...
		return ["<v:shape" + Rt({
			...
			"o:connecttype": "none"
		}), '<v:textbox><div style="text-align:left"></div></v:textbox>', '<x:ClientData ObjectType="Note">', "<x:MoveWithCells/>", "<x:SizeWithCells/>", Ot("x:Anchor", [a.c + 1, 0, a.r + 1, 0, a.c + 3, 20, a.r + 5, 20].join(",")), Ot("x:AutoFill", "False"), Ot("x:Row", String(a.r)), Ot("x:Column", String(a.c)), e[1].hidden ? "": "<x:Visible/>", "</x:ClientData>", "</v:shape>"].join("")
	}
	function Dh(e, r, t, a) {
		var n = e["!data"] != null;
		var i;
	...
	function Uh(e, r, t) {
		...
		e.forEach(function(e) {
			var n = ""; (e[1] || []).forEach(function(i, s) {
				...
				a.push(It("threadedComment", Ot("text", i.t || ""), f))
			})
		});
	...
	function Gh(e) {
		...
		e.forEach(function(e) {
			e[1].forEach(function(a) {
				...
				_a(r, 635, Hh([i, a]));
				if (a.t && a.t.length > 0) _a(r, 637, on(a));
				_a(r, 636);
				delete a.iauthor
			})
		});
	...
	var jh = "application/vnd.ms-office.vbaProject";
	function Kh(e) {
	...
	var Zh = ["xlsb", "xlsm", "xlam", "biff8", "xla"];
	function Jh() {
		return {
			"!type": "dialog"
		}
	...
	var tu = /(^|[^._A-Z0-9])(\$?)([A-Z]{1,2}|[A-W][A-Z]{2}|X[A-E][A-Z]|XF[A-D])(\$?)(\d{1,7})(?![_.\(A-Za-z0-9])/g;
	try {
		tu = /(^|[^._A-Z0-9])([$]?)([A-Z]{1,2}|[A-W][A-Z]{2}|X[A-E][A-Z]|XF[A-D])([$]?)(10[0-3]\d{4}|104[0-7]\d{3}|1048[0-4]\d{2}|10485[0-6]\d|104857[0-6]|[1-9]\d{0,5})(?![_.\(A-Za-z0-9])/g
	} catch(au) {}
	var nu = function() {
	...
	function hu(e, r, t) {
		var a = 2;
		if (t) {
			if (t.biff >= 2 && t.biff <= 5) return uu(e, r, t);
	...
	function vu(e, r, t) {
		if (t && t.biff >= 2 && t.biff <= 5) return pu(e, r, t);
	...
	function wu(e, r, t) {
		var a = (e[e.l++] & 96) >> 5;
		var n = hu(e, t.biff >= 2 && t.biff <= 5 ? 6 : 8, t);
		return [a, n]
	}
	function ku(e, r, t) {
		var a = (e[e.l++] & 96) >> 5;
	...
	function Uu(e, r, t) {
		var a = e[e.l++];
		var n = e._R(1),
		i = t && t.biff <= 3 ? [a == 88 ? -1 : 0, e._R(1)] : Bu(e);
	...
	function Ku(e, r, t) {
		var a = e._R(t.biff == 12 ? 4 : 2);
		var n = [];
		for (var i = 0; i != a; ++i) n.push((t.biff == 12 ? Cn: Hs)(e, 8));
		return n
	}
	function Yu(e, r, t) {
		var a = 0,
		...
		for (var i = 0,
		s = []; i != a && (s[i] = []); ++i) for (var f = 0; f != n; ++f) s[i][f] = ju(e, t.biff);
		return s
	}
	function Zu(e, r, t) {
		var a = e._R(1) >>> 5 & 3;
	...
	var md = sd;
	var gd = sd;
	var bd = ["Data", "All", "Headers", "??", "?Data2", "??", "?DataHeaders", "??", "Totals", "??", "??", "??", "?DataTotals", "??", "??", "??", "?Current"];
	function wd(e) {
		e.l += 2;
		var r = e._R(2);
		var t = e._R(2);
	...
	function Id(e, r, t) {
		...
		while (a != e.l) {
			...
			i = e[e.l];
			n = _d[i] || _d[Sd[i]];
			if (i === 24 || i === 25) n = (i === 24 ? xd: Od)[e[e.l + 1]];
			if (!n || !n.f) {
				Aa(e, r)
			} else {
	...
	function Md(e, r, t, a, n) {
		...
		b = e[0].length; g < b; ++g) {
			...
			case "PtgName":
				u = w[1][2];
				var E = (a.names || [])[u - 1] || (a[0] || [])[u];
				var C = E ? E.Name: "SH33TJSNAME" + String(u);
			...
			if (n.biff != 3) if (p >= 0 && P.indexOf(e[0][g][0]) == -1) {
				w = e[0][p];
				var L = true;
				switch (w[1][0]) {
				case 4:
	...
	function Ud(e, r, t) {
		...
		n = t.biff == 2 ? 1 : 2;
		var i, s = e._R(n);
		if (s == 65535) return [[], Aa(e, r - 2)];
		var f = Id(e, s, t);
		if (r !== s + n) i = Rd(e, r - s - n, f, t);
		e.l = a;
		return [f, i]
	}
	function Bd(e, r, t) {
	...
	function zd(e, r, t) {
		...
		var n, i = e._R(2);
		var s = Id(e, i, t);
		if (i == 65535) return [[], Aa(e, r - 2)];
		if (r !== i + 2) n = Rd(e, a - i - 2, s, t);
		return [s, n]
	}
	function Hd(e) {
		var r;
		if (ca(e, e.l + 6) !== 65535) return [Sn(e), "n"];
		switch (e[e.l]) {
		case 0:
			e.l += 8;
			return ["String", "s"];
	...
	function Vd(e) {
		if (e == null) {
			...
			r._W(2, 65535);
			return r
		} else if (typeof e == "number") return xn(e);
		return xn(0)
	}
	function Xd(e, r, t) {
		var a = e.l + r;
	...
	function dv(e) {
		var r = "of:=" + e.replace(tu, "$1[.$2$3$4$5]").replace(/\]:\[/g, ":");
	...
	var mv = {};
	var gv = {};
	var bv = typeof Map !== "undefined";
	function wv(e, r, t) {
		var a = 0,
		n = e.length;
		if (t) {
			if (bv ? t.has(r) : Object.prototype.hasOwnProperty.call(t, r)) {
				var i = bv ? t.get(r) : t[r];
				for (; a < i.length; ++a) {
					if (e[i[a]].t === r) {
						e.Count++;
						return i[a]
	...
	function yv(e, r, t, a, n, i, s) {
		...
		if ((!a || a.cellText !== false) && e.t !== "z") try {
			...
			} else if (e.t === "d") e.w = ze(r, dr(e.v, !!s), gv);
			else e.w = ze(r, e.v, gv)
		} catch(f) {
			if (a.WTF) throw f
		}
	...
	var _v = /<(?:\w:)?mergeCell ref=["'][A-Z0-9:]+['"]\s*[\/]?>/g;
	var Sv = /<(?:\w+:)?sheetData[^>]*>([\s\S]*)<\/(?:\w+:)?sheetData>/;
	var xv = /<(?:\w:)?hyperlink [^>]*>/gm;
	var Ov = /"(\w*:\w*)"/;
	var Rv = /<(?:\w:)?col\b[^>]*[\/]?>/g;
	...
	function Lv(e, r, t, a, n, i, s) {
		...
		var u = o.match(Fv);
		if (u) Uv(u[0], f, n, t);
		else if (u = o.match(Dv)) Bv(u[0], u[1] || "", f, n, t, s, i);
		var d = (o.match(/<(?:\w*:)?dimension/) || {
			index: -1
		}).index;
		if (d > 0) {
			var v = o.slice(d, d + 50).match(Ov);
			if (v && !(r && r.nodim)) Cv(f, v[1])
		}
		var p = o.match(Pv);
		if (p && p[1]) qv(p[1], n);
		var m = [];
		...
		if (A) Xv(f, A, a);
		var y = c.match(Nv);
		if (y) f["!margins"] = $v(rt(y[0]));
		var E;
		if (E = c.match(/legacyDrawing r:id="(.*?)"/)) f["!legrel"] = E[1];
	...
	function ep(e, r, t, a, n, i, s) {
		...
		var h = e.t == "z" || e.v == null ? "": Ot("v", lt(f)),
		u = {
			r: r
		};
		var d = Av(a.cellXfs, e, a);
		if (d !== 0) u.s = d;
		switch (e.t) {
		case "n":
			break;
		...
		default:
			...
			if (a && a.bookSST) {
				h = Ot("v", "" + wv(a.Strings, e.v, a.revStrings));
				u.t = "s";
				break
			} else u.t = "str";
			break;
	...
	var rp = function() {
		...
		var i = At("v"),
		s = At("f");
		return function f(l, o, c, h, u, d, v) {
			var p = 0,
			m = "",
			g = [],
			b = [],
			...
			for (var z = l.split(r), H = 0, V = z.length; H != V; ++H) {
				...
				case ">":
					...
					if (c && c.cellStyles) {
						...
						if (E.ht) {
							U = true;
							M.hpt = parseFloat(E.ht);
							M.hpx = lc(M.hpt)
						}
						if (E.hidden && pt(E.hidden)) {
							U = true;
							M.hidden = true
						}
						if (E.outlineLevel != null) {
							U = true;
							M.level = +E.outlineLevel
						}
						if (U) L[C - 1] = M
					}
					break;
				...
				for (p = 0; p != g.length; ++p) {
					...
					if (b != null && b.length === 2) {
						...
						for (k = 0; k != A.length; ++k) {
							if ((T = A.charCodeAt(k) - 64) < 1 || T > 26) break;
							w = 26 * w + T
						}--w;
						_ = w
					} else++_;
					for (k = 0; k != m.length; ++k) if (m.charCodeAt(k) === 62) break; ++k;
					E = rt(m.slice(0, k), true);
					if (!E.r) E.r = za({
						r: C - 1,
						c: _
					});
					...
					if ((b = A.match(i)) != null && b[1] !== "") y.v = it(b[1]);
					if (c.cellFormula) {
						if ((b = A.match(s)) != null) {
							if (b[1] == "") {
								if (b[0].indexOf('t="shared"') > -1) {
									x = rt(b[0]);
									if (D[x.si]) y.f = su(D[x.si][1], D[x.si][2], E.r)
								}
							} else {
								y.f = it(kt(b[1]), true);
								if (!c.xlfn) y.f = lu(y.f);
								if (b[0].indexOf('t="array"') > -1) {
									y.F = (A.match(n) || [])[1];
									if (y.F.indexOf(":") > -1) F.push([Ga(y.F), y.F])
								} else if (b[0].indexOf('t="shared"') > -1) {
									x = rt(b[0]);
									var j = it(kt(b[1]));
									if (!c.xlfn) j = lu(j);
									D[parseInt(x.si, 10)] = [x, j, E.r]
								}
							}
						} else if (b = A.match(/<f[^>]*\/>/)) {
							x = rt(b[0]);
						...
						var K = Wa(E.r);
						for (k = 0; k < F.length; ++k) if (K.r >= F[k][0].s.r && K.r <= F[k][0].e.r) if (K.c >= F[k][0].s.c && K.c <= F[k][0].e.c) y.F = F[k][1]
					}
					if (E.t == null && y.v === undefined) {
						if (y.f || y.F) {
							y.v = 0;
							y.t = "n"
						} else if (!B) continue;
					...
					case "n":
						...
						break;
					case "s":
						if (typeof y.v == "undefined") {
							if (!B) continue;
							y.t = "z"
						} else {
							S = mv[parseInt(y.v, 10)];
							y.v = S.t;
							y.r = S.r;
							if (c.cellHTML) y.h = S.h
						}
						break;
					case "str":
						y.t = "s";
						y.v = y.v != null ? it(kt(y.v), true) : "";
						if (c.cellHTML) y.h = ht(y.v);
						break;
					case "inlineStr":
						b = A.match(a);
						y.t = "s";
					...
					if (I && E.s !== undefined) {
						N = d.CellXf[E.s];
						if (N != null) {
							if (N.numFmtId != null) O = N.numFmtId;
							if (c.cellStyles) {
								if (N.fillId != null) R = N.fillId
							}
						}
					}
					yv(y, O, R, c, u, d, W);
					if (c.cellDates && I && y.t == "n" && Le(q[O])) {
						y.v = vr(y.v + (W ? 1462 : 0));
						y.t = typeof y.v == "number" ? "n": "d"
					}
					if (E.cm && c.xlmeta) {
						var Y = (c.xlmeta.Cell || [])[ + E.cm - 1];
						if (Y && Y.type == "XLDAPR") y.D = true
					}
					var Z;
					if (c.nodim) {
						Z = Wa(E.r);
						if (h.s.r > Z.r) h.s.r = Z.r;
						if (h.e.r < Z.r) h.e.r = Z.r
					}
					if (P) {
						Z = Wa(E.r);
	...
	function tp(e, r, t, a) {
		...
		for (u = s.s.c; u <= s.e.c; ++u) c[u] = La(u);
		for (h = s.s.r; h <= s.e.r; ++h) {
			i = [];
			o = Na(h);
			for (u = s.s.c; u <= s.e.c; ++u) {
				l = c[u] + o;
				var w = v ? (e["!data"][h] || [])[u] : e[l];
				if (w === undefined) continue;
				if ((f = ep(w, l, e, r, t, a, b)) != null) i.push(f)
			}
			if (i.length > 0 || d && d[h]) {
				p = {
					r: o
	...
	function ap(e, r, t, a) {
		...
		if (l["!links"].length > 0) {
			...
			l["!links"].forEach(function(e) {
				...
				if ((u = e[1].Target.indexOf("#")) > -1) d.location = lt(e[1].Target.slice(u + 1));
		...
		if (!r || r.ignoreEC || r.ignoreEC == void 0) n[n.length] = Ot("ignoredErrors", It("ignoredError", null, {
	...
	function ip(e, r, t) {
		...
		var c = t["!data"] != null;
		for (var h = 0; h < 16; ++h) {
			if (r.s.c > h + 1 << 10 || r.e.c < h << 10) continue;
			var u = -1,
			d = -1;
			for (var v = h << 10; v < h + 1 << 10; ++v) {
				o.c = v;
	...
	function sp(e, r, t, a) {
		var n = ip(a, t, r);
		if (n.length > 17 || (r["!rows"] || [])[a]) _a(e, 0, n)
	}
	var fp = Cn;
	var lp = _n;
	function op() {}
	...
	function Up(e, r, t) {
		...
		if (t == null) t = ya(12 + 4 * e.v.length);
		hn(r, t);
		tn(a, t);
	...
	function Yp(e, r) {
		var t = ya(50 + 4 * (e[1].Target.length + (e[1].Tooltip || "").length));
		_n({
			s: Wa(e[0]),
			e: Wa(e[0])
		},
	...
	function om(e, r, t, a, n, i, s) {
		...
		function U(e, r, b) {
			...
			case 62:
				...
				if (m = s.CellXf[e[0].iStyleRef]) yv(p, m.numFmtId, null, f, i, s, L > 0);
				w = e[0].c == -1 ? w + 1 : e[0].c;
				if (f.dense) {
					if (!l["!data"][g]) l["!data"][g] = [];
					l["!data"][g][w] = p
				} else l[La(w) + A] = p;
				if (f.cellFormula) {
					_ = false;
			...
			case 494:
				...
				for (g = e.rfx.s.r; g <= e.rfx.e.r; ++g) for (w = e.rfx.s.c; w <= e.rfx.e.c; ++w) {
					if (f.dense) {
						if (!l["!data"][g]) l["!data"][g] = [];
						if (!l["!data"][g][w]) l["!data"][g][w] = {
							t: "z",
							v: undefined
						};
						l["!data"][g][w].l = e
			...
			case 38:
				...
				break;
			default:
				if (r.T) {} else if (!u || f.WTF) throw new Error("Unexpected record 0x" + b.toString(16));
			}
		},
		f);
		delete f.supbooks;
	...
	function hm(e, r, t, a, n) {
		...
		var c = r["!data"] != null;
		var h = i.e.r;
		if (r["!rows"]) h = Math.max(i.e.r, r["!rows"].length - 1);
		for (var u = i.s.r; u <= h; ++u) {
			f = Na(u);
			sp(e, r, i, u);
			var d = false;
			if (u <= i.e.r) for (var v = i.s.c; v <= i.e.c; ++v) {
				if (u === i.s.r) l[v] = La(v);
				s = l[v] + f;
				var p = c ? (r["!data"][u] || [])[v] : r[s];
				if (!p) {
					d = false;
					continue
				}
				d = cm(e, p, u, v, a, r, d, o)
			}
		}
		_a(e, 146)
	}
	...
	function gm(e, r, t, a) {
		...
		for (var l = 0; l < s.length; ++l) {
			...
			o.Ref = $a(t.SheetNames[a]) + "!" + Xa(i);
			break
		}
		if (l == s.length) s.push({
			Name: "_xlnm._FilterDatabase",
			Sheet: a,
			Ref: $a(t.SheetNames[a]) + "!" + Xa(i)
		});
		_a(e, 161, _n(Ga(i)));
		_a(e, 162)
	}
	...
	function Tm(e, r, t, a) {
		...
		s["!comments"] = [];
		_a(n, 129);
		if (t.vbaraw || s["!outline"]) _a(n, 147, hp(f, s["!outline"]));
		_a(n, 148, lp(o));
		bm(n, s, t.Workbook);
		wm(n, s);
		dm(n, s, e, r, t);
		...
		um(n, s);
		pm(n, s, a);
		if (s["!margins"]) _a(n, 476, tm(s["!margins"]));
	...
	var Sm = [["allowRefreshQuery", false, "bool"], ["autoCompressPictures", true, "bool"], ["backupFile", false, "bool"], ["checkCompatibility", false, "bool"], ["CodeName", ""], ["date1904", false, "bool"], ["defaultThemeVersion", 0, "int"], ["filterPrivacy", false, "bool"], ["hidePivotFieldList", false, "bool"], ["promptedSolutions", false, "bool"], ["publishItems", false, "bool"], ["refreshAllConnections", false, "bool"], ["saveExternalLinkValues", true, "bool"], ["showBorderUnselectedTables", true, "bool"], ["showInkAnnotation", true, "bool"], ["showObjects", "all"], ["showPivotChartFilter", false, "bool"], ["updateLinks", "userSet"]];
	var xm = [["activeTab", 0, "int"], ["autoFilterDateGrouping", true, "bool"], ["firstSheet", 0, "int"], ["minimized", false, "bool"], ["showHorizontalScroll", true, "bool"], ["showSheetTabs", true, "bool"], ["showVerticalScroll", true, "bool"], ["tabRatio", 600, "int"], ["visibility", "visible"]];
	var Om = [];
	var Rm = [["calcCompleted", "true"], ["calcMode", "auto"], ["calcOnSave", "true"], ["concurrentCalc", "true"], ["fullCalcOnLoad", "false"], ["fullPrecision", "true"], ["iterate", "false"], ["iterateCount", "100"], ["iterateDelta", "0.001"], ["refMode", "A1"]];
	function Im(e, r) {
		for (var t = 0; t != e.length; ++t) {
			var a = e[t];
			for (var n = 0; n != r.length; ++n) {
	...
	function Fm(e) {
		...
		Im(e.WBView, xm);
		Im(e.Sheets, Om);
		gv.date1904 = pt(e.WBProps.date1904)
	}
	function Dm(e) {
	...
	function Um(e) {
		...
		for (var t = 0; t < e.SheetNames.length; ++t) Ev(e.Sheets[e.SheetNames[t]], e.SheetNames[t], t);
	...
	function Km(e, r) {
		...
		if (e.Comment) i.push(gn(e.Comment));
		else {
			var s = ya(4);
			s._W(4, 4294967295);
			i.push(s)
	...
	function ag(e, r) {
		...
		_a(t, 131);
		_a(t, 128, Jm());
		_a(t, 153, $m(e.Workbook && e.Workbook.WBProps || null));
		Qm(t, e, r);
		Zm(t, e, r);
		tg(t, e);
		if ((e.Workbook || {}).Names) eg(t, e);
		_a(t, 132);
		return t.end()
	}
	function ng(e, r, t) {
	...
	function sg(e, r, t, a, n, i, s, f) {
		if (r.slice(-4) === ".bin") return _m(e, a, t, n, i, s, f);
		return Em(e, a, t, n, i, s, f)
	}
	function fg(e, r, t, a, n, i, s, f) {
		if (r.slice(-4) === ".bin") return Qh(e, a, t, n, i, s, f);
		return eu(e, a, t, n, i, s, f)
	}
	function lg(e, r, t, a, n, i, s, f) {
		if (r.slice(-4) === ".bin") return Jh(e, a, t, n, i, s, f);
		return qh(e, a, t, n, i, s, f)
	}
	function og(e, r, t, a) {
	...
	function cg(e, r, t) {
		if (r.slice(-4) === ".bin") return uo(e, t);
		return lo(e, t)
	}
	function hg(e, r, t) {
		if (r.slice(-4) === ".bin") return $h(e, t);
		return Ph(e, t)
	}
	function ug(e, r, t) {
		if (r.slice(-4) === ".bin") return _h(e, r, t);
		return Eh(e, r, t)
	}
	function dg(e, r, t, a) {
		if (t.slice(-4) === ".bin") return xh(e, r, t, a);
		return Sh(e, r, t, a)
	}
	function vg(e, r, t) {
		if (r.slice(-4) === ".bin") return kh(e, r, t);
		return Ah(e, r, t)
	}
	var pg = /([\w:]+)=((?:")([^"]*)(?:")|(?:')([^']*)(?:'))/g;
	var mg = /([\w:]+)=((?:")(?:[^"]*)(?:")|(?:')(?:[^']*)(?:'))/;
	...
	function Ag(e, r, t, a) {
		...
		if (!t || t.cellText !== false) try {
			...
			} else e.w = kg(r || "General", e.v, a)
		} catch(n) {
			if (t.WTF) throw n
		}
		try {
			var i = wg[r] || r || "General";
			if (t.cellNF) e.z = i;
	...
	function Eg(e, r, t, a, n, i, s, f, l, o, c) {
		var h = "General",
		u = a.StyleID,
		d = {};
		o = o || {};
		...
		while (i[u] !== undefined) {
			if (i[u].nf) h = i[u].nf;
			if (i[u].Interior) v.push(i[u].Interior);
			if (!i[u].Parent) break;
			u = i[u].Parent
		}
		switch (t.Type) {
	...
	function Sg(e, r) {
		...
		case "data":
			if (G == "data") {
				if (l[1] === "/") {
					if ((h = o.pop())[0] !== l[3]) throw new Error("Bad state: " + h.join("|"))
				} else if (l[0].charAt(l[0].length - 2) !== "/") o.push([l[3], true]);
				break
			}
			if (o[o.length - 1][1]) break;
			if (l[1] === "/") Eg(n.slice(T, l.index), S, k, o[o.length - 1][0] == "comment" ? P: g, {
				c: A,
				r: y
			},
			C, L[A], w, B, t, X.WBProps.date1904);
			else {
				S = "";
				k = gg(l[0]);
		...
		case "cell":
			if (l[1] === "/") {
				if (D.length > 0) g.c = D;
				if ((!t.sheetRows || t.sheetRows > y) && g.v !== void 0) {
					if (t.dense) {
						if (!p["!data"][y]) p["!data"][y] = [];
						p["!data"][y][A] = g
					} else p[La(A) + Na(y)] = g
				}
				if (g.HRef) {
				...
				if (g.MergeAcross || g.MergeDown) {
					H = A + (parseInt(g.MergeAcross, 10) | 0);
		...
		case "worksheet":
			if (l[1] === "/") {
				if ((h = o.pop())[0] !== l[3]) throw new Error("Bad state: " + h.join("|"));
				d.push(m);
				if (E.s.r <= E.e.r && E.s.c <= E.e.c) {
					p["!ref"] = Va(E);
					if (t.sheetRows && t.sheetRows <= E.e.r) {
						p["!fullref"] = p["!ref"];
						E.e.r = t.sheetRows - 1;
						p["!ref"] = Va(E)
					}
		...
		case "style":
			...
			break;
		case "numberformat":
			_.nf = it(gg(l[0]).Format || "General");
			if (wg[_.nf]) _.nf = wg[_.nf];
			for (var Y = 0; Y != 392; ++Y) if (q[Y] == _.nf) break;
		...
		case "namedrange":
			...
			if (X.Sheets.length > 0) ee.Sheet = X.Sheets.length - 1;
			X.Names.push(ee);
			break;
		case "namedcell":
			break;
		...
		case "font":
			...
			else if (l[1] === "/") S += n.slice(x, l.index);
			else x = l.index + l[0].length;
			break;
		case "interior":
		...
		case "appname":
			if (l[0].slice(-2) === "/>") break;
			else if (l[1] === "/") Mi(R, G, n.slice(N, l.index));
		...
		case "comment":
			if (l[1] === "/") {
				...
				o.push([l[3], false]);
				h = gg(l[0]);
				if (!pt(h["ShowAlways"] || "0")) D.hidden = true;
				P = {
					a: h.Author
				}
			}
		...
		case "null":
			break;
		default:
			if (o.length == 0 && l[3] == "document") return Wb(n, t);
			if (o.length == 0 && l[3] == "uof") return Wb(n, t);
			var te = true;
			...
			if (o[o.length - 1][0] === "customdocumentproperties") {
				if (l[0].slice(-2) === "/>") break;
				else if (l[1] === "/") Tg(I, G, F, n.slice(N, l.index));
				else {
					F = l;
	...
	function Pg(e, r, t, a) {
		...
		if (e["!protect"]) {
			n.push(Ot("ProtectContents", "True"));
			if (e["!protect"].objects) n.push(Ot("ProtectObjects", "True"));
			if (e["!protect"].scenarios) n.push(Ot("ProtectScenarios", "True"));
			if (e["!protect"].selectLockedCells != null && !e["!protect"].selectLockedCells) n.push(Ot("EnableSelection", "NoSelection"));
	...
	function Mg(e, r, t, a, n, i, s) {
		if (!e || e.v == undefined && e.f == undefined) return "";
		var f = {};
		if (e.f) f["ss:Formula"] = "=" + lt(nu(e.f, s));
	...
	function Wg(e, r, t) {
		...
		a.push(Pg(i, r, e, t));
		if (i["!autofilter"]) a.push('<AutoFilter x:Range="' + nu(Xa(i["!autofilter"].ref), {
			r: 0,
			c: 0
	...
	function zg(e, r) {
		...
		t.push("");
		t.push("");
		for (var a = 0; a < e.SheetNames.length; ++a) t.push(It("Worksheet", Wg(a, r, e), {
	...
	function jg(e, r) {
		...
		while (e.l < e.length - 1) {
			...
			if (Y && Y.f) {
				...
				case 1212:
					{
						...
						if (d) {
							if (!f) break;
							w[za(f.cell)] = J[0];
							v = r.dense ? (n["!data"][f.cell.r] || [])[f.cell.c] : n[za(f.cell)]; (v || {}).f = "" + Md(J[0], s, u, U, I)
						}
					}
					break;
				case 253:
					T = Gg(o[J.isst].t, J.ixfe, "s");
				...
				case 1054:
					{
						if (I.biff >= 3 && I.biff <= 4) {
							H[z++] = J[1];
							for (var he = 0; he < z + 163; ++he) if (q[he] == J[1]) break;
							if (he >= 163) Je(J[1], z + 163)
						} else Je(J[1], J[0])
					}
					break;
				case 30:
					{
						H[z++] = J;
						for (var ue = 0; ue < z + 163; ++ue) if (q[ue] == J) break;
						if (ue >= 163) Je(J, z + 163)
					}
					break;
				case 229:
					F = F.concat(J);
				...
				case 440:
					{
						for (g = J[0].s.r; g <= J[0].e.r; ++g) for (m = J[0].s.c; m <= J[0].e.c; ++m) {
							v = r.dense ? (n["!data"][g] || [])[m] : n[za({
								c: m,
								r: g
							})];
							if (v) v.l = J[1]
		...
		if (U.names.length > 0) C.Names = U.names;
		t.Workbook = C;
		return t
	}
	var Kg = {
	...
	function Yg(e, r, t) {
		...
		if (r.HeadingPairs && r.TitlesOfParts) {
			Oi(r.HeadingPairs, r.TitlesOfParts, r, t);
	...
	function Zg(e, r) {
		...
		for (i = 0; i < n.length; ++i) {
			if (as.indexOf(n[i][0]) > -1 || xi.indexOf(n[i][0]) > -1) continue;
			if (n[i][1] == null) continue;
			o.push(n[i])
		}
		if (a.length) Qe.utils.cfb_add(r, "/SummaryInformation", fs(a, Kg.SI, l, Zn));
		if (t.length || o.length) Qe.utils.cfb_add(r, "/DocumentSummaryInformation", fs(t, Kg.DSI, f, Yn, o.length ? o: null, Kg.UDI))
	}
	function Jg(e, r) {
		if (!r) r = {};
		ek(r);
		...
		if (r.bookProps && !r.bookSheets) n = {};
			...
			var f = C ? "buffer": "array";
			if (a && a.content) n = jg(a.content, r);
			...
			if (r.bookVBA && e.FullPaths && Qe.find(e, "/_VBA_PROJECT_CUR/VBA/dir")) n.vbaraw = Kh(e)
		}
		var l = {};
		if (e.FullPaths) Yg(e, l, r);
	...
	function qg(e, r) {
		...
		Qe.utils.cfb_add(a, n, yb(e, t));
		if (t.biff == 8 && (e.Props || e.Custprops)) Zg(e, a);
		if (t.biff == 8 && e.vbaraw) Yh(a, Qe.read(e.vbaraw, {
	...
	function ib(e, r) {
		r.forEach(function(r) {
			...
			if (t.length <= 2048) return rb(e, 28, ll(t, r[1], r[2]));
			rb(e, 28, ll(t.slice(0, 2048), r[1], r[2], t.length));
			for (var a = 2048; a < t.length; a += 2048) rb(e, 28, ll(t.slice(a, Math.min(a + 2048, t.length)), -1, -1, Math.min(2048, t.length - a)))
		})
	}
	function sb(e, r, t, a, n, i) {
		var s = 0;
		if (r.z != null) {
		...
		case "n":
			...
			if (n.biff == 2 && l == (l | 0) && l >= 0 && l < 65536) rb(e, 2, Ul(t, a, l, f, s));
			else if (isNaN(l)) rb(e, 5, ab(t, a, 36, "e"));
			else if (!isFinite(l)) rb(e, 5, ab(t, a, 7, "e"));
			else rb(e, 3, Ll(t, a, l, f, s));
			return;
		case "b":
			;
		case "e":
			rb(e, 5, ab(t, a, r.v, r.t));
			return;
		case "s":
			;
		case "str":
			rb(e, 4, nb(t, a, r.v == null ? "": String(r.v).slice(0, 255)));
			return;
		}
		rb(e, 1, Fl(null, t, a))
	}
	...
	function lb(e, r) {
		...
		rb(a, t.biff == 4 ? 1033 : t.biff == 3 ? 521 : 9, Qs(e, 16, t));
		if (((e.Workbook || {}).WBProps || {}).date1904) rb(a, 34, us(true));
		t.cellXfs = [{
			numFmtId: 0
		}];
		...
		t._Fonts = [];
		var s = Ca();
		fb(s, e.Sheets[e.SheetNames[n]], n, t, e);
		t._BIFF2FmtTable.forEach(function(e) {
			if (t.biff <= 3) rb(a, 30, xf(e));
			else rb(a, 1054, Of(e))
		});
	...
	cb = [];
	function hb() {
		var e = ya(82 + 8 * cb.length);
		e._W(2, 15);
		e._W(2, 61440);
		e._W(4, 74 + 8 * cb.length); {
			e._W(2, 0);
			e._W(2, 61446);
			e._W(4, 16 + 8 * cb.length); {
				e._W(4, ob);
				e._W(4, cb.length + 1);
				var r = 0;
				for (var t = 0; t < cb.length; ++t) r += cb[t] && cb[t][1] || 0;
				e._W(4, r);
				e._W(4, cb.length)
			}
	...
	function vb(e, r, t) {
		if (!r) return; [[5, 8], [23, 26], [41, 44], [50, 392]].forEach(function(a) {
			for (var n = a[0]; n <= a[1]; ++n) if (r[n] != null) rb(e, 1054, _f(n, r[n], t))
		})
	}
	function pb(e, r) {
		var t = ya(19);
	...
	function mb(e, r) {
		for (var t = 0; t < 16; ++t) rb(e, 224, Mf({
			numFmtId: 0,
			style: true
		},
		0, r));
	...
	function bb(e, r) {
		...
		r.forEach(function(r, a) {
			if (++t <= 256 && r) {
				rb(e, 125, Cl(kv(a, r), a))
			}
		})
	}
	function wb(e, r, t, a, n, i) {
		var s = 16 + Av(n.cellXfs, r, n);
		if (r.v == null && !r.bf) {
			rb(e, 513, Ls(t, a, s));
			return
		}
		if (r.bf) rb(e, 6, $d(r, t, a, n, s));
		else switch (r.t) {
		case "d":
			;
		case "n":
			var f = r.t == "d" ? dr(wr(r.v, i), i) : r.v;
			if (isNaN(f)) rb(e, 517, jf(t, a, 36, s, n, "e"));
			else if (!isFinite(f)) rb(e, 517, jf(t, a, 7, s, n, "e"));
			else rb(e, 515, Yf(t, a, f, s, n));
			break;
		case "b":
			;
		case "e":
			rb(e, 517, jf(t, a, r.v, s, n, r.t));
			break;
		case "s":
			;
		case "str":
			if (n.bookSST) {
				...
				rb(e, 253, Af(t, a, l, s, n))
			} else rb(e, 516, Ef(t, a, (r.v == null ? "": String(r.v)).slice(0, 255), s, n));
			break;
		default:
			rb(e, 513, Ls(t, a, s));
		}
	...
	function kb(e, r, t) {
		...
		var m = [];
		var g = [];
		for (var b = d.s.c; b <= d.e.c; ++b) u[b] = La(b);
		for (var w = d.s.r; w <= d.e.r; ++w) {
			if (l) g = i["!data"][w] || [];
			h = Na(w);
			for (b = d.s.c; b <= d.e.c; ++b) {
				c = u[b] + h;
				var k = l ? g[b] : i[c];
				if (!k) continue;
				wb(a, k, w, b, r, p);
				if (o && k.l) i["!links"].push([c, k.l]);
				if (k.c) m.push([k.c, w, b])
			}
		}
		var T = f.CodeName || f.name || n;
		if (o) ub(a, m);
		else ib(a, m);
		if (o) rb(a, 574, gf((s.Views || [])[0]));
		if (o && (i["!merges"] || []).length) rb(a, 229, cl(i["!merges"]));
		if (o) gb(a, i);
		rb(a, 442, Es(T, r));
		if (o) pb(a, i);
		rb(a, 10);
	...
	function Tb(e, r, t) {
		...
		l = t.biff == 5;
		rb(a, 2057, Qs(e, 5, t));
		if (t.bookType == "xla") rb(a, 135);
		rb(a, 225, f ? vs(1200) : null);
		rb(a, 193, os(2));
		if (l) rb(a, 191);
		if (l) rb(a, 192);
		rb(a, 226);
		rb(a, 92, tf("SheetJS", t));
		rb(a, 66, vs(f ? 1200 : 1252));
		if (f) rb(a, 353, vs(0));
		if (f) rb(a, 448);
		rb(a, 317, xl(e.SheetNames.length));
		if (f && e.vbaraw) rb(a, 211);
		if (f && e.vbaraw) {
		...
		rb(a, 18, us(false));
		rb(a, 19, vs(0));
		if (f) rb(a, 431, us(false));
		if (f) rb(a, 444, vs(0));
		rb(a, 61, pf(t));
		rb(a, 64, us(false));
		rb(a, 141, vs(0));
		rb(a, 34, us(Dm(e) == "true"));
		rb(a, 14, us(true));
		if (f) rb(a, 439, us(false));
		rb(a, 218, vs(0));
		db(a, e, t);
		vb(a, e.SSF, t);
		mb(a, t);
		if (f) rb(a, 352, us(false));
		var c = a.end();
		var h = Ca();
		if (f) rb(h, 140, kl());
		if (f && cb.length) rb(h, 235, hb());
		if (f && t.Strings) tb(h, 252, lf(t.Strings, t));
		rb(h, 10);
		var u = h.end();
		var d = Ca();
		var v = 0,
	...
	function Ab(e, r) {
		...
		if (!e.Props) e.Props = {};
		for (var n = 0; n < e.SheetNames.length; ++n) a[a.length] = kb(n, t, e);
		a.unshift(Tb(e, a, t));
		return P(a)
	}
	function yb(e, r) {
	...
	function Eb(e, r) {
		...
		for (f = 0; f < o.length; ++f) {
			...
			for (l = 0; l < w.length; ++l) {
				...
				var T = k,
				A = 0;
				while (T.charAt(0) == "<" && (A = T.indexOf(">")) > -1) T = T.slice(A + 1);
				for (var y = 0; y < p.length; ++y) {
					var E = p[y];
					if (E.s.c == h && E.s.r < c && c <= E.e.r) {
						h = E.e.c + 1;
						y = -1
					}
				}
				var C = rt(k.slice(0, k.indexOf(">")));
				d = C.colspan ? +C.colspan: 1;
				if ((u = +C.rowspan) > 1 || d > 1) p.push({
					s: {
						r: c,
						c: h
					},
				...
				if (t.raw || !T.trim().length || _ == "s") {} else if (T === "TRUE") S = {
					t: "b",
					v: true
				};
				else if (T === "FALSE") S = {
	...
	function Cb(e, r, t, a) {
		...
		for (var l = r.s.c; l <= r.e.c; ++l) {
			...
			for (var h = 0; h < n.length; ++h) {
				if (n[h].s.r > t || n[h].s.c > l) continue;
				if (n[h].e.r < t || n[h].e.c < l) continue;
				if (n[h].s.r < t || n[h].s.c < l) {
					o = -1;
					break
				}
				o = n[h].e.r - n[h].s.r + 1;
			...
			if (o < 0) continue;
			var u = La(l) + Na(t);
			var d = f ? (e["!data"][t] || [])[l] : e[u];
			var v = d && d.v != null && (d.h || ht(d.w || (Ka(d), d.w) || "")) || "";
			s = {};
			if (o > 1) s.rowspan = o;
			if (c > 1) s.colspan = c;
			if (a.editable) v = '<span contenteditable="true">' + v + "</span>";
				...
				if (d.l && (d.l.Target || "#").charAt(0) != "#") v = '<a href="' + ht(d.l.Target) + '">' + v + "</a>"
			}
			s.id = (a.id || "sjs") + "-" + u;
			i.push(It("td", v, s))
		}
	...
	var _b = '<html><head><meta charset="utf-8"/><title>SheetJS Table Export</title></head><body>';
	var Sb = "</body></html>";
	function xb(e, r) {
	...
	function Rb(e, r) {
		var t = r || {};
		var a = t.header != null ? t.header: _b;
		var n = t.footer != null ? t.footer: Sb;
		var i = [a];
		var s = Ha(e["!ref"] || "A1");
		i.push(Ob(e, s, t));
		if (e["!ref"]) for (var f = s.s.r; f <= s.e.r; ++f) i.push(Cb(e, s, f, t));
		i.push("</table>" + n);
		return i.join("")
	}
	function Ib(e, r, t) {
		...
		if (e["!ref"]) {
			var h = Ha(e["!ref"]);
			c.s.r = Math.min(c.s.r, h.s.r);
			c.s.c = Math.min(c.s.c, h.s.c);
			c.e.r = Math.max(c.e.r, h.e.r);
			c.e.c = Math.max(c.e.c, h.e.c);
			if (s == -1) c.e.r = s = h.e.r + 1
		}
		var u = [],
		d = 0;
		var v = e["!rows"] || (e["!rows"] = []);
		...
		for (; p < a.length && m < o; ++p) {
			...
			for (g = b = 0; g < A.length; ++g) {
				var y = A[g];
				if (n.display && Db(y)) continue;
				var E = y.hasAttribute("data-v") ? y.getAttribute("data-v") : y.hasAttribute("v") ? y.getAttribute("v") : yt(y.innerHTML);
				var C = y.getAttribute("data-z") || y.getAttribute("z");
				for (d = 0; d < u.length; ++d) {
					var _ = u[d];
					if (_.s.c == b + f && _.s.r < m + s && m + s <= _.e.r) {
						b = _.e.c + 1 - f;
						d = -1
					}
				}
				...
				var x = y.getAttribute("data-t") || y.getAttribute("t") || "";
				if (E != null) {
					if (E.length == 0) S.t = x || "z";
					else if (n.raw || E.trim().length == 0 || x == "s") {} else if (E === "TRUE") S = {
						t: "b",
						v: true
					};
					else if (E === "FALSE") S = {
					...
					else if (!isNaN(yr(E))) S = {
						t: "n",
						v: yr(E)
					};
					else if (!isNaN(Ir(E).getDate())) {
						S = {
							t: "d",
							v: wr(E)
						};
	...
	function Mb(e, r, t) {
		...
		while (i = Pt.exec(n)) {
			...
			case "text":
				if (i[1] === "/") {
					d = n.slice(h, Pt.lastIndex - i[0].length);
			...
			case "seconds":
				{
					...
					if (o["decimal-places"]) f += "." + Ar("0", +o["decimal-places"])
				}
				break;
			case "year":
				{
			...
			case "scientific-number":
				o = rt(i[0], false);
				f += "0." + Ar("0", +o["min-decimal-places"] || +o["decimal-places"] || 2) + Ar("?", +o["decimal-places"] - +o["min-decimal-places"] || 0) + "E" + (pt(o["forced-exponent-sign"]) ? "+": "") + Ar("0", +o["min-exponent-digits"] || 2);
				break;
			case "fraction":
				o = rt(i[0], false);
				if (!+o["min-integer-digits"]) f += "#";
				else f += Ar("0", +o["min-integer-digits"]);
				f += " ";
				f += Ar("?", +o["min-numerator-digits"] || 1);
				f += "/";
				if ( + o["denominator-value"]) f += o["denominator-value"];
				else f += Ar("?", +o["min-denominator-digits"] || 1);
				break;
			case "currency-symbol":
				if (i[1] === "/") {
					f += '"' + n.slice(h, Pt.lastIndex - i[0].length).replace(/"/g, '""') + '"'
				} else if (i[0].charAt(i[0].length - 2) !== "/") {
					h = Pt.lastIndex
				} else f += "$";
				break;
			...
			case "number":
				...
				o = rt(i[0], false);
				l = "";
				l += Ar("0", +o["min-integer-digits"] || 1);
				if (pt(o["grouping"])) l = ue(Ar("#", Math.max(0, 4 - l.length)) + l);
				if ( + o["min-decimal-places"] || +o["decimal-places"]) l += ".";
				if ( + o["min-decimal-places"]) l += Ar("0", +o["min-decimal-places"] || 1);
				if ( + o["decimal-places"] - ( + o["min-decimal-places"] || 0)) l += Ar("0", +o["decimal-places"] - ( + o["min-decimal-places"] || 0));
				f += l;
				break;
			case "embedded-text":
				if (i[1] === "/") {
					if (c == 0) f += '"' + n.slice(h, Pt.lastIndex - i[0].length).replace(/"/g, '""') + '"';
					else f = f.slice(0, c) + '"' + n.slice(h, Pt.lastIndex - i[0].length).replace(/"/g, '""') + '"' + f.slice(c)
				} else if (i[0].charAt(i[0].length - 2) !== "/") {
					h = Pt.lastIndex;
	...
	function Ub(e, r, t) {
		...
		case "工作表":
			if (m[1] === "/") {
				if (O.e.c >= O.s.c && O.e.r >= O.s.r) p["!ref"] = Va(O);
				else p["!ref"] = "A1:A1";
				if (a.sheetRows > 0 && a.sheetRows <= O.e.r) {
					p["!fullref"] = p["!ref"];
					O.e.r = a.sheetRows - 1;
					p["!ref"] = Va(O)
				}
		...
		case "行":
			...
			U = +u["number-rows-repeated"] || 1;
			if (U < 10) for (Z = 0; Z < U; ++Z) if (R > 0) M[S + Z] = {
				level: R
			};
			x = -1;
			break;
		...
		case "数据":
			if (m[0].charAt(m[0].length - 2) === "/") {++x;
				...
				if (w.formula && a.cellFormula != false) g.f = uv(it(w.formula));
				if (w["style-name"] && N[w["style-name"]]) g.z = N[w["style-name"]];
				...
				if (a.cellFormula) {
					...
					if (w.formula) g.f = uv(w.formula);
					else for (Z = 0; Z < W.length; ++Z) if (S >= W[Z][0].s.r && S <= W[Z][0].e.r) if (x >= W[Z][0].s.c && x <= W[Z][0].e.c) g.F = W[Z][1]
				}
				...
				case "float":
					...
					if (a.cellDates && g.z && Le(g.z)) {
						g.v = vr(g.v + (z.WBProps.date1904 ? 1462 : 0));
				...
				case "date":
					g.t = "d";
					g.v = wr(w["date-value"], z.WBProps.date1904);
					if (!a.cellDates) {
						g.t = "n";
						g.v = dr(g.v, z.WBProps.date1904)
					}
					if (!g.z) g.z = "m/d/yy";
					break;
				case "time":
				...
				if (!K || a.sheetStubs) {
					if (! (a.sheetRows && a.sheetRows <= S)) {
						for (var q = 0; q < U; ++q) {
							B = parseInt(w["number-columns-repeated"] || "1", 10);
							if (a.dense) {
								if (!p["!data"][S + q]) p["!data"][S + q] = [];
								p["!data"][S + q][x] = q == 0 ? g: Tr(g);
								while (--B > 0) p["!data"][S + q][x + B] = Tr(g)
							} else {
								p[za({
									r: S + q,
									c: x
		...
		case "annotation":
			if (m[1] === "/") {
				...
				i.push([m[3], false]);
				var Q = rt(m[0], true);
				if (! (Q["display"] && pt(Q["display"]))) X.hidden = true;
				y = k;
				E = T;
				_ = C;
				k = "";
	...
	function Bb(e, r) {
		...
		var i = Ub(kt(n), r, a);
		if (Ur(e, "meta.xml")) i.Props = Ei(Wr(e, "meta.xml"));
		i.bookType = "ods";
		return i
	}
	function Wb(e, r) {
	...
	var zb = function() {
		...
		var r = "<office:document-styles " + Rt({
	...
	var Xb = function() {
		...
		var t = function(t, a, n, i, s, f) {
			...
			var v = t["!data"] != null;
			if (t["!cols"]) {
				for (c = 0; c <= h.e.c; ++c) l.push("        <table:table-column" + (t["!cols"][c] ? ' table:style-name="co' + t["!cols"][c].ods + '"': "") + "></table:table-column>\n")
			}
			var p = "",
			m = t["!rows"] || [];
			for (o = 0; o < h.s.r; ++o) {
			...
			for (; o <= h.e.r; ++o) {
				...
				for (; c <= h.e.c; ++c) {
					...
					for (d = 0; d != u.length; ++d) {
						...
						if (u[d].s.r > o) continue;
						if (u[d].e.c < c) continue;
						if (u[d].e.r < o) continue;
						if (u[d].s.c != c || u[d].s.r != o) g = true;
					...
					T = v ? (t["!data"][o] || [])[c] : t[k];
					if (T && T.f) {
						b["table:formula"] = lt(dv(T.f));
						if (T.F) {
							if (T.F.slice(0, k.length) == k) {
								var A = Ha(T.F);
								b["table:number-matrix-columns-spanned"] = A.e.c - A.s.c + 1;
								b["table:number-matrix-rows-spanned"] = A.e.r - A.s.r + 1
							}
						}
					}
					if (!T) {
					...
					case "b":
						...
						b["office:boolean-value"] = T.v ? "true": "false";
						break;
					case "n":
						w = T.w || String(T.v || 0);
						b["office:value-type"] = "float";
						b["office:value"] = T.v || 0;
						break;
					case "s":
						;
					case "str":
					...
					case "d":
						...
						b["office:date-value"] = wr(T.v, f).toISOString();
					...
					if (T.l && T.l.Target) {
						var E = T.l.Target;
						E = E.charAt(0) == "#" ? "#" + pv(E.slice(1)) : E;
						if (E.charAt(0) != "#" && !E.match(/^\w+:/)) E = "../" + E;
						y = It("text:a", y, {
							"xlink:href": E.replace(/&/g, "&amp;")
						})
					}
					if (s[T.z]) b["table:style-name"] = "ce" + s[T.z].slice(1);
					var C = It("text:p", y, {});
					if (T.c) {
						var _ = "",
						S = "",
						...
						for (var O = 0; O < T.c.length; ++O) {
							if (!_ && T.c[O].a) _ = T.c[O].a;
							S += "<text:p>" + e(T.c[O].t) + "</text:p>"
						}
						if (!T.c.hidden) x["office:display"] = true;
						C = It("office:annotation", S, x) + C
					}
					l.push("          " + It("table:table-cell", C, b) + "\n")
				}
				l.push("        </table:table-row>\n")
			}
			if ((a.Workbook || {}).Names) l.push(Vb(a.Workbook.Names, a.SheetNames, n));
			l.push("      </table:table>\n");
			return l.join("")
		};
		var a = function(e, r) {
		...
		return function n(e, r) {
			...
			if ((e.Workbook || {}).Names) n.push(Vb(e.Workbook.Names, e.SheetNames, -1));
			n.push("    </office:spreadsheet>\n");
			n.push("  </office:body>\n");
	...
	function $b(e, r) {
		if (r.bookType == "fods") return Xb(e, r);
		var t = $r();
		var a = "";
		var n = [];
		var i = [];
		a = "mimetype";
		Xr(t, a, "application/vnd.oasis.opendocument.spreadsheet");
		a = "content.xml";
		Xr(t, a, Xb(e, r));
		n.push([a, "text/xml"]);
	...
	function Yb(e) {
		return typeof TextEncoder != "undefined" ? (new TextEncoder).encode(e) : R(Tt(e))
	}
	function Zb(e) {
		var r = 0;
	...
	function hw(e, r) {
		...
		while (i < r.length) {
			...
			if (s == 0) {
				...
				var h = n.length - 1,
				u = o;
				while (h >= 0 && u >= n[h].length) {
					u -= n[h].length; --h
				}
				if (h < 0) {
					if (u == 0) u = n[h = 0].length;
					else throw new Error("Invalid offset beyond length")
				}
				if (c < u) n.push(n[h][Gb](n[h].length - u, n[h].length - u + c));
				else {
					if (u > 0) {
						n.push(n[h][Gb](n[h].length - u));
						c -= u
					}++h;
					while (c >= n[h].length) {
						n.push(n[h]);
					...
					if (c) n.push(n[h][Gb](0, c))
				}
				if (n.length > 25) n = [Zb(n)]
			}
		}
		var d = 0;
	...
	function pw(e, r, t, a, n) {
		...
		e: if (t & (c > 4 ? 8 : 4) && e.t == "n" && o == 7) {
			var u = ((i = h[7]) == null ? void 0 : i[0]) ? nw(h[7][0].data) : -1;
			if (u == -1) break e;
			var d = ((s = h[15]) == null ? void 0 : s[0]) ? nw(h[15][0].data) : -1;
			var v = ((f = h[16]) == null ? void 0 : f[0]) ? nw(h[16][0].data) : -1;
			var p = ((l = h[40]) == null ? void 0 : l[0]) ? nw(h[40][0].data) : -1;
			var m = e.v,
			g = m;
			r: if (p) {
				if (m == 0) {
			...
			if (d <= 8 && v >= 8) {
				...
				w.push((d >= 8 ? "[m]": "m") + '"m"');
				if (u == 0) b.push((d == 8 && v == 8 || g >= 10 ? "": "0") + g);
			...
			if (d <= 16 && v >= 16) {
				...
				w.push((d >= 16 ? "[s]": "s") + '"s"');
				if (u == 0) b.push((v == 16 && d == 16 || g >= 10 ? "": "0") + g);
	...
	function mw(e, r, t, a) {
		...
		o = NaN,
		c = 0,
		h = new Date(Date.UTC(2001, 0, 1));
		var u = t > 1 ? 12 : 8;
		if (i & 2) {
			l = n.getUint32(u, true);
			u += 4
		}
		u += Jb(i & (t > 1 ? 3468 : 396)) * 4;
		if (i & 512) {
			s = n.getUint32(u, true);
			u += 4
		}
		u += Jb(i & (t > 1 ? 12288 : 4096)) * 4;
		if (i & 16) {
			f = n.getUint32(u, true);
			u += 4
		}
		if (i & 32) {
			o = n.getFloat64(u, true);
			u += 8
		}
		if (i & 64) {
			h.setTime(h.getTime() + (c = n.getFloat64(u, true)) * 1e3);
			u += 8
		}
		if (t > 1) {
			i = n.getUint32(8, true) >>> 16;
			if (i & 255) {
				if (l == -1) l = n.getUint32(u, true);
				u += 4
			}
		}
		var d;
		...
		case 9:
			{
				...
				} else throw new Error("Unsupported cell type ".concat(e[Gb](0, 4)))
			}
			break;
		default:
			throw new Error("Unsupported cell type ".concat(e[Gb](0, 4)));
		}
	...
	function gw(e, r, t) {
		...
		if (i & 4) {
			d.setTime(d.getTime() + (u = a.getFloat64(s, true)) * 1e3);
			s += 8
		}
		if (i & 8) {
		...
		case 9:
			{
				...
				} else throw new Error("Unsupported cell type ".concat(e[1], " : ").concat(i & 31, " : ").concat(e[Gb](0, 4)))
			}
			break;
		case 10:
			m = {
			...
			break;
		default:
			throw new Error("Unsupported cell type ".concat(e[1], " : ").concat(i & 31, " : ").concat(e[Gb](0, 4)));
		}
		s += Jb(i & 4096) * 4;
		if (i & 516096) {
		...
		if (i & 524288) {
			...
			s += 4;
			if (r.cmnt[w]) m.c = Ow(r.cmnt[w])
		}
		if (o > -1) pw(m, g | 5 << 8, i >> 13, r.ofmt[o], r.nfmt[o]);
		if (g == 7) m.v /= 86400;
		return m
	}
	function bw(e, r) {
			...
			case 8:
				{
					...
					var h = nw(c.meta[1][0].data);
					if (h != 2001) throw new Error("2000 unexpected reference to ".concat(h));
					var u = sw(c.data);
					var d = {
						v: u[3].map(function(e) {
							return Kb(e.data)
						}).join("")
					};
					i[f] = d;
					e: if ((t = u == null ? void 0 : u[11]) == null ? void 0 : t[0]) {
						var v = (n = sw(u[11][0].data)) == null ? void 0 : n[1];
						if (!v) break e;
						v.forEach(function(r) {
							...
							if ((t = i[2]) == null ? void 0 : t[0]) {
								...
								case 2032:
									var l = sw(s.data);
									if (((n = l == null ? void 0 : l[2]) == null ? void 0 : n[0]) && !d.l) d.l = Kb(l[2][0].data);
									break;
								case 2039:
									break;
								default:
	...
	function _w(e, r) {
		var t, a, n, i, s, f, l, o, c, h, u, d, v, p;
		var m = sw(e);
		var g = nw(m[1][0].data) >>> 0;
		var b = nw(m[2][0].data) >>> 0;
		...
		for (var C = 0; C < k.length / 2; ++C) {
			var _ = y.getUint16(C * 2, true);
			if (_ < 65535) E.push([C, _])
		}
		if (E.length != b) throw "Expected ".concat(b, " cells, found ").concat(E.length);
		var S = [];
		for (C = 0; C < E.length - 1; ++C) S[E[C][0]] = T[Gb](E[C][1] * A, E[C + 1][1] * A);
		if (E.length >= 1) S[E[E.length - 1][0]] = T[Gb](E[E.length - 1][1] * A);
		return {
			R: g,
			cells: S
		}
	...
	function xw(e, r) {
		var t, a, n, i, s, f, l, o, c, h;
		var u = {
			t: "",
			a: ""
		};
		var d = sw(r);
		if ((a = (t = d == null ? void 0 : d[1]) == null ? void 0 : t[0]) == null ? void 0 : a.data) u.t = Kb((i = (n = d == null ? void 0 : d[1]) == null ? void 0 : n[0]) == null ? void 0 : i.data) || "";
		if ((f = (s = d == null ? void 0 : d[3]) == null ? void 0 : s[0]) == null ? void 0 : f.data) {
			...
			var p = sw(v.data);
			if ((h = (c = p[1]) == null ? void 0 : c[0]) == null ? void 0 : h.data) u.a = Kb(p[1][0].data)
		}
		if (d == null ? void 0 : d[4]) {
			u.replies = [];
			d[4].forEach(function(r) {
				var t = e[Tw(r.data)][0];
				u.replies.push(xw(e, t.data))
			})
		}
		return u
	}
	...
	function Iw(e, r, t, a) {
		...
		var b = sw(v[4][0].data);
		var w = vw();
		if ((n = b[4]) == null ? void 0 : n[0]) w.sst = Cw(e, e[Tw(b[4][0].data)][0]);
		if ((i = b[6]) == null ? void 0 : i[0]) w.fmla = Cw(e, e[Tw(b[6][0].data)][0]);
		if ((s = b[11]) == null ? void 0 : s[0]) w.ofmt = Cw(e, e[Tw(b[11][0].data)][0]);
		if ((f = b[12]) == null ? void 0 : f[0]) w.ferr = Cw(e, e[Tw(b[12][0].data)][0]);
		if ((l = b[17]) == null ? void 0 : l[0]) w.rsst = Cw(e, e[Tw(b[17][0].data)][0]);
		if ((o = b[19]) == null ? void 0 : o[0]) w.cmnt = Cw(e, e[Tw(b[19][0].data)][0]);
		if ((c = b[22]) == null ? void 0 : c[0]) w.nfmt = Cw(e, e[Tw(b[22][0].data)][0]);
		var k = sw(b[3][0].data);
		var T = 0;
		if (! ((h = b[9]) == null ? void 0 : h[0])) throw "NUMBERS file missing row tree";
		var A = sw(b[9][0].data)[1].map(function(e) {
			return sw(e.data)
		});
		...
		if ((u = b[13]) == null ? void 0 : u[0]) {
			var y = e[Tw(b[13][0].data)][0];
			var E = nw(y.meta[1][0].data);
			if (E != 6144) throw new Error("Expected merge type 6144, found ".concat(E));
			t["!merges"] = (d = sw(y.data)) == null ? void 0 : d[1].map(function(e) {
				var r = sw(e.data);
				var t = jb(sw(r[1][0].data)[1][0].data),
				a = jb(sw(r[2][0].data)[1][0].data);
				return {
					s: {
	...
	function Fw(e, r, t) {
		...
		var n = sw(r.data);
		var i = {
			name: ((a = n[1]) == null ? void 0 : a[0]) ? Kb(n[1][0].data) : "",
			sheets: []
		};
		var s = lw(n[2], Tw);
	...
	function Pw(e, r) {
		...
		var h = ((l = (f = (s = (i = o == null ? void 0 : o[1]) == null ? void 0 : i[0]) == null ? void 0 : s.meta) == null ? void 0 : f[1]) == null ? void 0 : l[0].data) && nw(o[1][0].meta[1][0].data) == 1 && o[1][0];
		if (!h) c.forEach(function(e) {
	...
	function Lw(e, r, t) {
		...
		for (var g = 0; g < e.length; ++g) {
			if (e[g] == null || e[g].t == "z" && !((i = e[g].c) == null ? void 0 : i.length) || e[g].t == "e") {
				c.setUint16(g * 2, 65535, true);
				d.setUint16(g * 2, 65535);
				continue
			}
			c.setUint16(g * 2, h / m, true);
			d.setUint16(g * 2, v / m, true);
			var b, w;
			switch (e[g].t) {
			case "d":
		...
		s[2][0].data = rw(f);
		s[5][0].data = rw(5);
		for (; g < s[7][0].data.length / 2; ++g) {
			c.setUint16(g * 2, 65535, true);
			d.setUint16(g * 2, 65535, true)
		}
		s[6][0].data = Zb(u);
		s[3][0].data = Zb(p);
		s[8] = [{
	...
	function Bw(e) {
		...
		e.FileIndex.map(function(r, t) {
			...
			ow(uw(a.content)).forEach(function(e) {
				t.push(e.id);
				r[e.id] = {
					deps: [],
					location: n,
		...
		e.FileIndex.forEach(function(e) {
			if (!e.name.match(/\.iwa/)) return;
			if (e.content[0] != 0) return;
			ow(uw(e.content)).forEach(function(e) {
	...
	function jw(e, r, t, a) {
		...
		var i = e[3].findIndex(function(e) {
			var r, t;
			var a = sw(e.data);
			if ((r = a[3]) == null ? void 0 : r[0]) return Kb(a[3][0].data) == n;
			if (((t = a[2]) == null ? void 0 : t[0]) && Kb(a[2][0].data) == n) return true;
			return false
		});
		var s = sw(e[3][i].data);
	...
	function Yw(e, r, t) {
		...
		function(t, a) {
			...
			var u = Xw(e, r, h);
			u.id = f;
			if (r[s].location == r[f].location) a.push(u);
			else Vw(e, r, f,
			function(e, r) {
				return r.push(u)
			});
		...
		function(a, n) {
			...
			var c = Kb(o[1][0].data),
			h = c.replace(/-[A-Z0-9]*/, "-".concat(("0000" + t.toString(16)).slice(-4)));
			o[1][0].data = Yb(h); [12, 13, 29, 31, 32, 33, 39, 44, 47, 81, 82, 84].forEach(function(e) {
				return delete o[e]
			});
			if (o[45]) {
				var u = sw(o[45][0].data);
				var d = Tw(u[1][0].data);
				Ew(a, d);
				delete o[45]
			}
			...
			var p = sw(o[4][0].data); { [2, 4, 5, 6, 11, 12, 13, 15, 16, 17, 18, 19, 20, 21, 22].forEach(function(t) {
					...
					if (r[l].location == r[f].location) n.push(c);
						...
						var h = r[o].location.replace(/^Root Entry\//, "").replace(/^Index\//, "").replace(/\.iwa$/, "");
						Vw(e, r, 2,
						function(e) {
							var t = sw(e.messages[0].data);
							$w(t, o, h);
	...
	function qw(e, r, t, a, n, i) {
		...
		var p = sw(a.messages[0].data); {
			...
			delete p[46];
			var m = sw(p[4][0].data); {
				var g = Tw(sw(m[1][0].data)[2][0].data);
				Vw(e, r, g,
				function(e, r) {
					var t;
				...
				var k = sw(m[3][0].data); {
					...
					var A = Tw(sw(k[1][0].data)[2][0].data);
					var y = function() {
						var t = Xw(e, r, 2);
						...
						Qe.utils.cfb_del(e, r[A].location);
						Vw(e, r, 2,
						function(e) {
							var t = sw(e.messages[0].data);
					...
					for (var C = 0; C < E; ++C) {
						...
						r);
						r[_].location = "Root Entry/Index/Tables/Tile-".concat(_, ".iwa");
						var S = [[], [{
							type: 0,
							data: rw(0)
						}], [{
							type: 0,
							data: rw(Math.min(s.e.r + 1, (C + 1) * T))
						}], [{
							type: 0,
							data: rw(0)
						}], [{
							type: 0,
							data: rw(Math.min((C + 1) * T, s.e.r + 1) - C * T)
						}], [], [{
							type: 0,
							data: rw(5)
						}], [{
						...
						for (var x = C * T; x <= Math.min(s.e.r, (C + 1) * T - 1); ++x) {
							var O = Lw(l[x], v, Jw);
							O[1][0].data = rw(x - C * T);
							S[5].push({
								data: fw(O),
						...
						var R = {
							id: _,
							messages: [Mw(6002, fw(S))]
						};
						var I = dw(cw([R]));
						Qe.utils.cfb_add(e, "/Index/Tables/Tile-".concat(_, ".iwa"), I);
						Vw(e, r, 2,
						function(e) {
							var t = sw(e.messages[0].data);
							t[3].push({
							...
							t[1] = [{
								type: 0,
								data: rw(Math.max(_ + 1, nw(t[1][0].data)))
							}];
							jw(t, r, i, _);
							e.messages[0].data = fw(t)
						});
	...
	function ik(e, r, t, a, n, i, s, f, l, o, c, h) {
		try {
			i[a] = ui(zr(e, t, true), r);
			var u = Wr(e, r);
			var d;
			switch (f) {
			case "sheet":
				d = ig(u, r, n, l, i[a], o, c, h);
				break;
			case "chart":
				d = sg(u, r, n, l, i[a], o, c, h);
				if (!d || !d["!drawel"]) break;
				var v = jr(d["!drawel"].Target, r);
				var p = hi(v);
				var m = Oh(zr(e, v, true), ui(zr(e, p, true), v));
				var g = jr(m, v);
				var b = hi(g);
				d = ym(zr(e, g, true), g, l, ui(zr(e, b, true), g), o, d);
				break;
			case "macro":
				d = fg(u, r, n, l, i[a], o, c, h);
				break;
			case "dialog":
				d = lg(u, r, n, l, i[a], o, c, h);
				break;
			default:
			...
			if (i && i[a]) ir(i[a]).forEach(function(t) {
				...
				if (i[a][t].Type == ci.CMNT) {
					n = jr(i[a][t].Target, r);
					w = hg(Wr(e, n, true), n, l);
					if (!w || !w.length) return;
					Dh(d, w, false)
				}
				if (i[a][t].Type == ci.TCMNT) {
					n = jr(i[a][t].Target, r);
					k = k.concat(Mh(Wr(e, n, true), l))
				}
			});
			if (k && k.length) Dh(d, k, true, l.people || []);
			nk(d, f, e, r, n, l, o, w)
		} catch(T) {
			if (l.WTF) throw T
		}
	...
	function fk(e, r) {
		...
		r = r || {};
		ek(r);
		if (Ur(e, "META-INF/manifest.xml")) return Bb(e, r);
		if (Ur(e, "objectdata.xml")) return Bb(e, r);
		...
		if (!r.bookSheets && !r.bookProps) {
			mv = [];
			if (i.sst) try {
				mv = cg(Wr(e, sk(i.sst)), i.sst, r)
			} catch(h) {
				if (r.WTF) throw h
			}
			if (r.cellStyles && i.themes.length) o = ah(zr(e, i.themes[0].replace(/^\//, ""), true) || "", r);
			if (i.style) c = og(Wr(e, sk(i.style)), i.style, o, r)
		}
		i.links.map(function(t) {
			try {
				var a = ui(zr(e, hi(sk(t))), t);
				return dg(Wr(e, sk(t)), a, t, r)
			} catch(n) {}
		});
		var u = ng(Wr(e, sk(i.workbooks[0])), i.workbooks[0], r);
		var d = {},
		v = "";
		...
		var m = {};
		if (r.bookSheets || r.bookProps) {
			if (u.Sheets) f = u.Sheets.map(function N(e) {
				return e.name
			});
		...
		f = {};
		var g = {};
		if (r.bookDeps && i.calcchain) g = ug(Wr(e, sk(i.calcchain)), i.calcchain, r);
		var b = 0;
		var w = {};
		var k, T; {
			var A = u.Sheets;
			...
			for (var y = 0; y != A.length; ++y) {
				d.SheetNames[y] = A[y].name
			}
		}
		var E = s ? "bin": "xml";
		var C = i.workbooks[0].lastIndexOf("/");
		var _ = (i.workbooks[0].slice(0, C + 1) + "_rels/" + i.workbooks[0].slice(C + 1) + ".rels").replace(/^\//, "");
		if (!Ur(e, _)) _ = "xl/_rels/workbook." + E + ".rels";
		var S = ui(zr(e, _, true), _.replace(/_rels.*/, "s5s"));
		if ((i.metadata || []).length >= 1) {
			r.xlmeta = vg(Wr(e, sk(i.metadata[0])), i.metadata[0], r)
		}
		if ((i.people || []).length >= 1) {
			r.people = Bh(Wr(e, sk(i.people[0])), r)
		}
		if (S) S = ak(S, u.Sheets);
		var x = Wr(e, "xl/worksheets/sheet.xml", true) ? 1 : 0;
		e: for (b = 0; b != d.Worksheets; ++b) {
			var O = "sheet";
			if (S && S[b]) {
				k = "xl/" + S[b][1].replace(/[\/]?xl\//, "");
				if (!Ur(e, k)) k = S[b][1];
				if (!Ur(e, k)) k = _.replace(/_rels\/.*$/, "") + S[b][1];
				O = S[b][2]
			} else {
				k = "xl/worksheets/sheet" + (b + 1 - x) + "." + E;
			...
			default:
				if (Array.isArray && Array.isArray(r.sheets)) {
					...
					for (var I = 0; I != r.sheets.length; ++I) {
						if (typeof r.sheets[I] == "number" && r.sheets[I] == b) R = 1;
						if (typeof r.sheets[I] == "string" && r.sheets[I].toLowerCase() == d.SheetNames[b].toLowerCase()) R = 1
					}
					if (!R) continue e
				};
			}
			ik(e, k, T, d.SheetNames[b], b, w, f, O, r, u, o, c)
		}
		m = {
			Directory: i,
			Workbook: u,
		...
		if (r && r.bookVBA) {
			...
			else if (i.defaults && i.defaults.bin === jh) m.vbaraw = Wr(e, "xl/vbaProject.bin", true)
		}
	...
	function ok(e, r) {
			...
			if (u) {
				...
				if (v && v.length > 0) {
					...
					if (g) {
						...
						vi(h, -1, "../threadedComments/threadedComment" + f + ".xml", ci.TCMNT)
					}
					m = "xl/comments" + f + "." + t;
					Xr(i, m, Gh(v, r));
					n.comments.push(m);
					vi(h, -1, "../comments" + f + "." + t, ci.CMNT);
					p = true
				}
				if (u["!legacy"]) {
					if (p) Xr(i, "xl/drawings/vmlDrawing" + f + ".vml", Nh(f, u["!comments"]))
				}
				delete u["!comments"];
				delete u["!legacy"]
			}
			if (h["!id"].rId1) Xr(i, hi(s), di(h))
		}
		if (r.Strings != null && r.Strings.length > 0) {
			s = "xl/sharedStrings." + t;
			Xr(i, s, mo(r.Strings, r));
			n.strs.push(s);
		...
		Xr(i, "[Content_Types].xml", oi(n, r));
		Xr(i, "_rels/.rels", di(r.rels));
		Xr(i, "xl/_rels/workbook." + t + ".rels", di(r.wbrels));
		delete r.revssf;
		delete r.ssf;
		return i
	}
	...
	function mk(e, r) {
		var t = e;
		if (r.type == "base64") t = E(t);
		if (typeof ArrayBuffer !== "undefined" && e instanceof ArrayBuffer) t = new Uint8Array(e);
		t = typeof a !== "undefined" ? a.utils.decode(1200, t.slice(2), "str") : C && Buffer.isBuffer(e) ? e.slice(2).toString("utf16le") : typeof Uint8Array !== "undefined" && t instanceof Uint8Array ? typeof TextDecoder !== "undefined" ? new TextDecoder("utf-16le").decode(t.slice(2)) : u(t.slice(2)) : h(t.slice(2));
		r.type = "binary";
		return vk(t, r)
	}
	function gk(e) {
	...
	function wk(e, r) {
		...
		gv = {};
		if (t.dateNF) gv.dateNF = t.dateNF;
		if (!t.type) t.type = C && Buffer.isBuffer(e) ? "buffer": "base64";
		if (t.type == "file") {
			t.type = C ? "buffer": "binary";
			n = nr(e);
			if (typeof Uint8Array !== "undefined" && !C) t.type = "array"
		}
		if (t.type == "string") {
			s = true;
			t.type = "binary";
		...
		switch ((i = hk(n, t))[0]) {
		case 208:
			if (i[1] === 207 && i[2] === 17 && i[3] === 224 && i[4] === 161 && i[5] === 177 && i[6] === 26 && i[7] === 225) return uk(Qe.read(n, t), t);
			break;
		case 9:
			if (i[1] <= 8) return Jg(n, t);
			break;
		case 60:
			return xg(n, t);
		case 73:
		...
		case 84:
			...
			break;
		case 80:
			return i[1] === 75 && i[2] < 9 && i[3] < 9 ? dk(n, t) : bk(e, n, t, s);
		case 239:
			return i[3] === 60 ? xg(n, t) : bk(e, n, t, s);
		case 255:
			if (i[1] === 254) {
				return mk(n, t)
		...
		if (Xl.indexOf(i[0]) > -1 && i[2] <= 12 && i[3] <= 31) return $l.to_workbook(n, t);
		return bk(e, n, t, s)
	}
	function kk(e, r) {
		var t = r || {};
	...
	function Ck(e, r) {
		var t = {};
		var a = C ? "nodebuffer": typeof Uint8Array !== "undefined" ? "array": "string";
	...
	function Ik(e, r) {
		...
		case "slk":
			;
		case "sylk":
			return Sk(Gl.from_sheet(e.Sheets[e.SheetNames[n]], t, e), t);
		case "htm":
			;
		case "html":
			return Sk(Rb(e.Sheets[e.SheetNames[n]], t), t);
		case "txt":
			return xk(zk(e.Sheets[e.SheetNames[n]], t), t);
		case "csv":
			return Sk(Wk(e.Sheets[e.SheetNames[n]], t), t, "\ufeff");
		case "dif":
			return Sk(jl.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
		case "dbf":
			return Ok($l.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
		case "prn":
			return Sk(Yl.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
		case "rtf":
			return Sk(Vo(e.Sheets[e.SheetNames[n]], t), t);
		case "eth":
			return Sk(Kl.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
		case "fods":
			return Sk($b(e, t), t);
		case "wk1":
			return Ok(Jl.sheet_to_wk1(e.Sheets[e.SheetNames[n]], t), t);
		case "wk3":
			return Ok(Jl.book_to_wk3(e, t), t);
		case "biff2":
			if (!t.biff) t.biff = 2;
		case "biff3":
			if (!t.biff) t.biff = 3;
	...
	function Lk(e, r, t, a, n, i, s) {
		...
		if (!h || e["!data"][t]) for (var v = r.s.c; v <= r.e.c; ++v) {
			var p = h ? (e["!data"][t] || [])[v] : e[a[v] + f];
			...
			if (i[v] != null) {
				if (m == null) {
					if (p.t == "e" && m === null) u[i[v]] = null;
					else if (l !== undefined) u[i[v]] = l;
					else if (o && m === null) u[i[v]] = null;
					else continue
				} else {
					u[i[v]] = (p.t === "n" && typeof s.rawNumbers === "boolean" ? s.rawNumbers: o) ? m: Ka(p, m, s)
				}
				if (m != null) c = false
			}
		}
	...
	function Mk(e, r) {
		...
		for (g = l.s.r + n; g <= l.e.r; ++g) {
			if ((T[g] || {}).hidden) continue;
			var A = Lk(e, l, g, u, a, i, o);
			if (A.isempty === false || (a === 1 ? o.blankrows !== false: !!o.blankrows)) d[v++] = A.row
		}
		d.length = v;
		return d
	}
	...
	function Bk(e, r, t, a, n, i, s, f) {
		...
		for (var v = r.s.c; v <= r.e.c; ++v) {
			...
			if (p == null) c = "";
				...
				for (var m = 0,
				g = 0; m !== c.length; ++m) if ((g = c.charCodeAt(m)) === n || g === i || g === 34 || f.forceQuotes) {
					c = '"' + c.replace(Uk, '""') + '"';
					break
				}
				if (c == "ID") c = '"ID"'
	...
	function Wk(e, r) {
		...
		for (var v = n.s.c; v <= n.e.c; ++v) if (! (u[v] || {}).hidden) h[v] = La(v);
		var p = 0;
		for (var m = n.s.r; m <= n.e.r; ++m) {
			if ((d[m] || {}).hidden) continue;
			c = Bk(e, n, m, h, s, l, i, a);
			if (c == null) {
				continue
			}
			...
			ir(e).forEach(function(t) {
				...
				if (o && typeof o === "object" && !(o instanceof Date)) {
					...
					if (typeof o == "number") c = "n";
						...
						h = m != null && m.z && Le(m.z) ? m.z: a.dateNF || q[14]
	...
	function $k(e, r, t) {
		...
		if (typeof r != "number") return $k(e, za(r));
		return $k(e, La(t || 0) + Na(r))
	}
	function Gk(e, r) {
		if (typeof r == "number") {
	...
	function iT(e, r) {
		var t = tT();
		var a = r || {};
		var n = a.header != null ? a.header: _b;
		var i = a.footer != null ? a.footer: Sb;
		t.push(n);
		var s = Ha(e["!ref"]);
		t.push(Ob(e, s, a));
		var f = s.s.r;
	...
	if (typeof Jg !== "undefined") e.parse_xlscfb = Jg;
	e.parse_zip = fk;
	e.read = wk;
	e.readFile = kk;
	e.readFileSync = kk;
